...
import io.druid.segment.Lucene10TestHelper;
...
{
  private static final ObjectMapper mapper = Lucene10TestHelper.segmentWalker.getMapper();

  @Test
  public void testPointFilter() throws Exception
  {
    ObjectMapper mapper = Lucene10TestHelper.segmentWalker.getMapper();
