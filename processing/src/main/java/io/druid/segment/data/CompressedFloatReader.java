...
/**
 */
public class CompressedFloatReader implements ColumnPartProvider<FloatValues>, ColumnPartSerde.Serializer
{
  public static final int MAX_FLOATS_IN_BUFFER = CompressedPools.BUFFER_SIZE / Float.BYTES;

  public static CompressedFloatReader fromByteBuffer(ByteBuffer buffer, ByteOrder order)
  {
    ...
    return new CompressedFloatReader(
        numRows,
        sizePer,
  ...
  @Override
  public Class<? extends FloatValues> provides()
  {
    return CompressedFloatValues.class;
  }

  @Override
  public FloatValues get()
  {
    return new CompressedFloatValues();
  }

  private class CompressedFloatValues implements FloatValues
  {
