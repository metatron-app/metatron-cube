...
/**
 */
public class ApproximateHistogramBase64AggregationTest
{
  ...
  public ApproximateHistogramBase64AggregationTest()
  {
  ...
  private MapBasedRow ingestAndQuery(boolean ignoreNulls) throws Exception
  {
    ...
    String query = "{"
        ...
        + "\"dimensions\": [],"
        + "\"aggregations\": ["
        + "  { \"type\": \"approxHistogramFold\", \"name\": \"index_ah\", \"fieldName\": \"index_ah\", \"base64\":true }"
        + "],"
        + "\"postAggregations\": ["
