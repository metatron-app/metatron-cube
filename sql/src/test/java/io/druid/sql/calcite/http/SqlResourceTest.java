...
public class SqlResourceTest extends CalciteTestBase
{
  ...
  public void testArrayResultFormat() throws Exception
  {
    ...
    Assert.assertEquals(
        ImmutableList.of(
            Arrays.asList("2000-01-01T00:00:00.000Z", 1, "", "a", 1.0, 1.0, "io.druid.query.aggregation.hyperloglog.HyperLogLogCollector", nullStr),
            Arrays.asList("2000-01-02T00:00:00.000Z", 1, "10.1", nullStr, 2.0, 2.0, "io.druid.query.aggregation.hyperloglog.HyperLogLogCollector", nullStr)
        ),
    ...
    Assert.assertEquals(
        ImmutableList.of(
            ImmutableMap.<String, Object>of(
                "PLAN",
                "DruidQueryRel(query=[{\"queryType\":\"timeseries\",\"dataSource\":{\"type\":\"table\",\"name\":\"foo\"},\"descending\":false,\"granularity\":{\"type\":\"all\"},\"aggregations\":[{\"type\":\"count\",\"name\":\"a0\"}],\"limitSpec\":{\"type\":\"noop\"},\"outputColumns\":[\"a0\"],\"context\":{\"groupby.sort.on.time\":false}}], signature=[{a0:long}])\n"
            )
        ),
        rows
    );
