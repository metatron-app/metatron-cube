...
public class KurtosisSerdeTest
{
  @Test
  public void testSerde()
  {
    ...
    ObjectStrategy strategy = new KurtosisSerde().getObjectStrategy();
    Assert.assertEquals(KurtosisAggregatorCollector.class, strategy.getClazz());
