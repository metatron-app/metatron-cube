...
public class Word2VecFunctions
{
  static void register(String name, Word2Vec w2vec)
  {
    Parser.register(new VectorFunc(name, w2vec));
    Parser.register(new SimilarityFunc(name, w2vec));
