...
/**
 */
public class CompressedLongReader implements ColumnPartProvider<LongValues>, ColumnPartSerde.Serializer
{
  public static final int MAX_LONGS_IN_BUFFER = CompressedPools.BUFFER_SIZE / Long.BYTES;

  public static CompressedLongReader fromByteBuffer(ByteBuffer buffer, ByteOrder order)
  {
    ...
    return new CompressedLongReader(
        numRows,
        sizePer,
  ...
  @Override
  public Class<? extends LongValues> provides()
  {
    return CompressedLongValues.class;
  }

  @Override
  public LongValues get()
  {
    return new CompressedLongValues();
  }

  private class CompressedLongValues implements LongValues
  {
