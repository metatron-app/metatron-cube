...
public class IndexSpecTest
{
  ...
  {
    final ObjectMapper mapper = LuceneTestHelper.segmentWalker.getMapper();
    ...
    Assert.assertEquals(
        "{\"bitmap\":{\"type\":\"roaring\"},\"secondaryIndexing\":{\"gis\":{\"type\":\"lucene\",\"textAnalyzer\":\"standard\",\"strategies\":[{\"type\":\"latlon\",\"fieldName\":\"coord\",\"latitude\":\"lat\",\"longitude\":\"lon\",\"crs\":null},{\"type\":\"text\",\"fieldName\":\"text\"}]}},\"allowNullForNumbers\":false}",
