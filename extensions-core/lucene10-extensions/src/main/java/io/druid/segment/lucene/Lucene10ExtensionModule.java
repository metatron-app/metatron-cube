...
public class Lucene10ExtensionModule implements DruidModule
{
  @Override
  public List<? extends Module> getJacksonModules()
  {
    return ImmutableList.of(
        ...
        new SimpleModule("lucene10-extension")
            .registerSubtypes(Lucene10IndexingSpec.class)
            .registerSubtypes(Lucene10IndexingSpec.SerDe.class)
            .registerSubtypes(Lucene10FSTSerDe.class)
