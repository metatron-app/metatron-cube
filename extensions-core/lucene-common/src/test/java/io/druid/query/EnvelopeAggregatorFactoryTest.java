...
public class EnvelopeAggregatorFactoryTest extends LuceneTestRunner
{
  @Override
  protected TestQuerySegmentWalker segmentWalker()
  {
    TestQuerySegmentWalker walker = LuceneTestHelper.segmentWalker.duplicate();
    walker.addIndex("seoul_roads", "seoul_roads_schema.json", "seoul_roads.tsv", true);
    walker.addIndex("estate_wkt", "estate_wkt_schema.json", "estate_wkt.csv", true);
    return walker;
  }
