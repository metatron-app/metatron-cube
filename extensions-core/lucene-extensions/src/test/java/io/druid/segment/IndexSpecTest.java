...
import io.druid.segment.lucene.Lucene7IndexingSpec;
...
public class IndexSpecTest
{
  ...
  public void testSecondaryIndexing() throws Exception
  {
    ...
    Assert.assertEquals(
        "{\"bitmap\":{\"type\":\"roaring\"},\"secondaryIndexing\":{\"gis\":{\"type\":\"lucene7\",\"textAnalyzer\":\"standard\",\"strategies\":[{\"type\":\"latlon\",\"fieldName\":\"coord\",\"latitude\":\"lat\",\"longitude\":\"lon\",\"crs\":null},{\"type\":\"text\",\"fieldName\":\"text\"}]}},\"allowNullForNumbers\":false}",
