...
/**
 */
public class CompressedDoubleReader implements ColumnPartProvider<DoubleValues>, ColumnPartSerde.Serializer
{
  public static final int MAX_DOUBLES_IN_BUFFER = CompressedPools.BUFFER_SIZE / Double.BYTES;

  public static CompressedDoubleReader fromByteBuffer(ByteBuffer buffer, ByteOrder order)
  {
    ...
    return new CompressedDoubleReader(
        numRows,
        sizePer,
  ...
  @Override
  public Class<? extends DoubleValues> provides()
  {
    return CompressedDoubleValues.class;
  }

  @Override
  public DoubleValues get()
  {
    return new CompressedDoubleValues();
  }

  private class CompressedDoubleValues implements DoubleValues
  {
