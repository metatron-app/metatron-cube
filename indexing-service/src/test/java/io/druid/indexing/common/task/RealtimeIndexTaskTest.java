...
public class RealtimeIndexTaskTest
{
  ...
  {
    final TaskConfig taskConfig = new TaskConfig(directory.getPath(), null, null, 50000, null, null, false, null, null);
  ...
  public long sumMetric(final Task task, final String metric) throws Exception
  {
    ...
    return results.isEmpty() ? 0 : results.get(0).getLongMetric(metric);
  }
}
