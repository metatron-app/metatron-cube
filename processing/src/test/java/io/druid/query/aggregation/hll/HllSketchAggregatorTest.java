...
public class HllSketchAggregatorTest
{
  ...
  public HllSketchAggregatorTest()
  {
    helper = AggregationTestHelper.createGroupByQueryAggregationTestHelper(Arrays.<Module>asList(), tempFolder);
  }
  ...
  public void ingestSketches() throws Exception
  {
    ...
    Assert.assertEquals(200, row.getDoubleMetric("sketch"), 0.1);
  }
