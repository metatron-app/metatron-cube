...
public class SchemalessTestSimple
{
  ...
  public static Collection<?> constructorFeeder() throws IOException
  {
    ...
    final QueryableIndex persistedIncrementalIndex = TestHelper.persistRealtimeAndLoadMMapped(incrementalIndex);
  ...
  final Granularity allGran = QueryGranularities.ALL;
