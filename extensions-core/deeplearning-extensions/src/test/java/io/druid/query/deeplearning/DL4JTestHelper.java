...
public class DL4JTestHelper extends TestHelper
{
  ...
  static {
    ...
    segmentWalker.addIndex("words", "words_schema.json", "words.csv", true);
    ...
    DeepLearningExtensionModule.bindFunctions(DL4JTestHelper.class.getClassLoader(), mapper);
  }
}
