...
public class TpchTestMore extends CalciteQueryTestHelper
{
  ...
  @Test
  public void tpch4314() throws Exception
  {
    JoinQueryConfig join = walker.getQueryConfig().getJoin();
    join.setHashJoinThreshold(1);
