...
import io.druid.segment.lucene.Lucene7ExtensionModule;
import io.druid.segment.lucene.LuceneCommonExtensionModule;
import io.druid.sql.calcite.util.TestQuerySegmentWalker;

import java.util.concurrent.Executors;

public class Lucene7TestHelper extends TestHelper
{
  ...
  static {
    ...
    for (Module module : new Lucene7ExtensionModule().getJacksonModules()) {
      mapper.registerModule(module);
    }
    ...
    segmentWalker.addIndex("estate", "estate7_schema.json", "estate.csv", true);
    segmentWalker.addIndex("estate_incremental", "estate7_schema.json", "estate.csv", false);
