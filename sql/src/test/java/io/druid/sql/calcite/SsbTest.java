...
public class SsbTest extends SsbTestHelper
{
  ...
  public void ssb1_1() throws Exception
  {
    ...
    if (semiJoin) {
      ...
      hook.verifyHooked(
          "RaHIL/JWLRfwrGbiMsCo1Q==",
          "StreamQuery{dataSource='ssb_date', filter=D_YEAR=='1992', columns=[__time]}",
          "TimeseriesQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', filter=(BoundDimFilter{1 <= LO_DISCOUNT <= 3(numeric)} && BoundDimFilter{LO_QUANTITY < 25(numeric)}), columns=[LO_DISCOUNT, LO_EXTENDEDPRICE, __time], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={__time:long}}}', aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_EXTENDEDPRICE * LO_DISCOUNT)', inputType='double'}], outputColumns=[a0]}",
          "StreamQuery{dataSource='ssb_lineorder', filter=(BoundDimFilter{1 <= LO_DISCOUNT <= 3(numeric)} && BoundDimFilter{LO_QUANTITY < 25(numeric)}), columns=[LO_DISCOUNT, LO_EXTENDEDPRICE, __time], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={__time:long}}}"
      );
    } else {
      hook.verifyHooked(
          "yJUDHIzrqAAuq1Ah3E/8xQ==",
          "TimeseriesQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', filter=(BoundDimFilter{1 <= LO_DISCOUNT <= 3(numeric)} && BoundDimFilter{LO_QUANTITY < 25(numeric)}), columns=[LO_DISCOUNT, LO_EXTENDEDPRICE, __time]}, StreamQuery{dataSource='ssb_date', filter=D_YEAR=='1992', columns=[__time], $hash=true}], timeColumnName=__time}', aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_EXTENDEDPRICE * LO_DISCOUNT)', inputType='double'}], outputColumns=[a0]}",
          "StreamQuery{dataSource='ssb_lineorder', filter=(BoundDimFilter{1 <= LO_DISCOUNT <= 3(numeric)} && BoundDimFilter{LO_QUANTITY < 25(numeric)}), columns=[LO_DISCOUNT, LO_EXTENDEDPRICE, __time]}",
    ...
    if (semiJoin) {
      if (broadcastJoin) {
        hook.verifyHooked(
            ...
            "GroupByQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', filter=InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]}, columns=[LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_PARTKEY], rightAlias=ssb_part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_BRAND1:string, P_PARTKEY:string}, applyFilter=true}]}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='P_BRAND1', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='LO_REVENUE', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}], limit=-1}, outputColumns=[a0, d0, d1]}",
            "StreamQuery{dataSource='ssb_lineorder', filter=InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]}, columns=[LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_PARTKEY], rightAlias=ssb_part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_BRAND1:string, P_PARTKEY:string}, applyFilter=true}]}"
        );
      } else {
        hook.verifyHooked(
      ...
      if (broadcastJoin) {
        hook.verifyHooked(
            "e/S1sPMCif/aB853H/QrXA==",
            "StreamQuery{dataSource='ssb_date', columns=[D_YEAR, __time]}",
            "StreamQuery{dataSource='ssb_part', filter=P_CATEGORY=='MFGR#12', columns=[P_BRAND1, P_PARTKEY]}",
            "StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_SUPPKEY]}",
            "GroupByQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', columns=[LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_PARTKEY], rightAlias=ssb_part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_BRAND1:string, P_PARTKEY:string}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date+ssb_part, leftJoinColumns=[LO_SUPPKEY], rightAlias=ssb_supplier, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_SUPPKEY:string}}]}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='P_BRAND1', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='LO_REVENUE', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}], limit=-1}, outputColumns=[a0, d0, d1]}",
  ...
  public static final String SSB2_2_PLAN =
      ...
      + "        DruidQueryRel(table=[druid.ssb_lineorder], scanProject=[$8, $10, $13, $16])\n"
      + "        DruidQueryRel(table=[druid.ssb_date], scanProject=[$13, $16])\n"
      + "      DruidQueryRel(table=[druid.ssb_part], scanFilter=[SEARCH($0, Sarg[['MFGR#2221'..'MFGR#2228']]:CHAR(9))], scanProject=[$0, $6])\n"
      + "    DruidQueryRel(table=[druid.ssb_supplier], scanFilter=[=($5, 'AMERICA')], scanProject=[$6])\n";
  ...
  public static final String SSB3_1_PLAN =
      ...
      + "    DruidQueryRel(table=[druid.ssb_date], scanFilter=[SEARCH($13, Sarg[[1992..1997]])], scanProject=[$13, $16])\n";
  ...
  public static final String SSB4_1_PLAN =
      ...
      + "            DruidQueryRel(table=[druid.ssb_date], scanProject=[$13, $16])\n"
      + "        DruidQueryRel(table=[druid.ssb_supplier], scanFilter=[=($5, 'AMERICA')], scanProject=[$6])\n"
      + "    DruidQueryRel(table=[druid.ssb_part], scanFilter=[SEARCH($4, Sarg['MFGR#1', 'MFGR#2']:CHAR(6))], scanProject=[$6])\n";

  public static final String SSB4_1_PLAN_JR =
      "DruidOuterQueryRel(scanProject=[$0, $1, -($2, $3)], group=[{0, 1}], profit=[SUM($2)], sort=[$0:ASC, $1:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[2], outputColumns=[0, 5, 2, 3])\n"
      + "    DruidQueryRel(table=[druid.ssb_date], scanProject=[$13, $16])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[1, 2, 3, 5])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[0], outputColumns=[0, 2, 3, 4])\n"
  ...
  public void ssb4_1() throws Exception
  {
    ...
    if (semiJoin) {
      if (broadcastJoin) {
        hook.verifyHooked(
            "TpQYGJ/ZCOSBdqUMq6eCQA==",
            "StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY, C_NATION]}",
            "StreamQuery{dataSource='ssb_date', columns=[D_YEAR, __time]}",
            "StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_SUPPKEY], $hash=true}",
            "StreamQuery{dataSource='ssb_part', filter=InDimFilter{dimension='P_MFGR', values=[MFGR#1, MFGR#2]}, columns=[P_PARTKEY]}",
            "GroupByQuery{dataSource='StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string, C_NATION:string}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_customer, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}]}', columns=[D_YEAR, __time0, C_CUSTKEY, C_NATION, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_supplier]}], timeColumnName=__time}', columns=[D_YEAR, C_NATION, LO_REVENUE, LO_SUPPLYCOST]}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='C_NATION', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_REVENUE - LO_SUPPLYCOST)', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}], limit=-1}, outputColumns=[d0, d1, a0]}",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string, C_NATION:string}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_customer, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}]}', columns=[D_YEAR, __time0, C_CUSTKEY, C_NATION, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_supplier]}], timeColumnName=__time}', columns=[D_YEAR, C_NATION, LO_REVENUE, LO_SUPPLYCOST]}",
            "StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string, C_NATION:string}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_customer, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}]}', columns=[D_YEAR, __time0, C_CUSTKEY, C_NATION, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
            "StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string, C_NATION:string}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_customer, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}]}"
        );
      } else {
        hook.verifyHooked(
            "bEanymQ3l5MqVNBJhV5eLQ==",
            "StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY, C_NATION], $hash=true}",
            "StreamQuery{dataSource='ssb_date', columns=[D_YEAR, __time], $hash=true}",
            "StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_SUPPKEY], $hash=true}",
            "StreamQuery{dataSource='ssb_part', filter=InDimFilter{dimension='P_MFGR', values=[MFGR#1, MFGR#2]}, columns=[P_PARTKEY]}",
            "GroupByQuery{dataSource='StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='LO_CUSTKEY', values=[101, 106, 117, 121, 122, 13, 133, 14, 141, 144, ..21 more]} && InDimFilter{dimension='__time', values=[694224000000, 694310400000, 694396800000, 694483200000, 694569600000, 694656000000, 694742400000, 694828800000, 694915200000, 695001600000, ..2 more]} && InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_customer]}], timeColumnName=__time}, MaterializedQuery{dataSource=[ssb_date]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, C_NATION, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_supplier]}], timeColumnName=__time}', columns=[D_YEAR, C_NATION, LO_REVENUE, LO_SUPPLYCOST]}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='C_NATION', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_REVENUE - LO_SUPPLYCOST)', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}], limit=-1}, outputColumns=[d0, d1, a0]}",
            ...
            "StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='LO_CUSTKEY', values=[101, 106, 117, 121, 122, 13, 133, 14, 141, 144, ..21 more]} && InDimFilter{dimension='__time', values=[694224000000, 694310400000, 694396800000, 694483200000, 694569600000, 694656000000, 694742400000, 694828800000, 694915200000, 695001600000, ..2 more]} && InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}"
        );
      }
    } else if (broadcastJoin) {
      hook.verifyHooked(
          "i2znvKLfKENB9ZTPaaYwgA==",
          "StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY, C_NATION]}",
          "StreamQuery{dataSource='ssb_date', columns=[D_YEAR, __time]}",
          "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string, C_NATION:string}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_customer, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}]}', columns=[D_YEAR, __time0, C_CUSTKEY, C_NATION, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_SUPPKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, C_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_part', filter=InDimFilter{dimension='P_MFGR', values=[MFGR#1, MFGR#2]}, columns=[P_PARTKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='C_NATION', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_REVENUE - LO_SUPPLYCOST)', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}], limit=-1}, outputColumns=[d0, d1, a0]}",
          "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string, C_NATION:string}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_customer, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}]}', columns=[D_YEAR, __time0, C_CUSTKEY, C_NATION, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_SUPPKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, C_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
          "StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string, C_NATION:string}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_customer, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}]}', columns=[D_YEAR, __time0, C_CUSTKEY, C_NATION, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
          "StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string, C_NATION:string}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_customer, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}]}",
          "StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_SUPPKEY], $hash=true}",
  ...
  public static final String SSB4_2_PLAN =
      ...
      + "            DruidJoinRel(joinType=[INNER], leftKeys=[5], rightKeys=[1])\n"
      + "              DruidQueryRel(table=[druid.ssb_lineorder], scanProject=[$1, $8, $10, $13, $14, $16])\n"
      + "              DruidQueryRel(table=[druid.ssb_date], scanFilter=[SEARCH($13, Sarg[1992, 1993])], scanProject=[$13, $16])\n"
      + "            DruidQueryRel(table=[druid.ssb_customer], scanFilter=[=($7, 'AMERICA')], scanProject=[$2])\n"
      + "        DruidQueryRel(table=[druid.ssb_supplier], scanFilter=[=($5, 'AMERICA')], scanProject=[$3, $6])\n"
      + "    DruidQueryRel(table=[druid.ssb_part], scanFilter=[SEARCH($4, Sarg['MFGR#1', 'MFGR#2']:CHAR(6))], scanProject=[$1, $6])\n";

  public static final String SSB4_2_PLAN_JR =
      "DruidOuterQueryRel(scanProject=[$0, $1, $2, -($3, $4)], group=[{0, 1, 2}], profit=[SUM($3)], sort=[$0:ASC, $1:ASC, $2:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[1], outputColumns=[5, 3, 4, 0, 1])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[1, 2, 3, 4, 5])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[1], outputColumns=[0, 2, 3, 4, 5, 6])\n"
    ...
    if (semiJoin) {
      if (broadcastJoin) {
        hook.verifyHooked(
            ...
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_supplier]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_part]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='S_NATION', outputName='d1'}, DefaultDimensionSpec{dimension='P_CATEGORY', outputName='d2'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_REVENUE - LO_SUPPLYCOST)', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, a0]}",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_supplier]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
            "StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
            "StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}"
        );
      } else {
        hook.verifyHooked(
            "zK3NGObJfhWhCxhjw44YEQ==",
            ...
            "StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_NATION, S_SUPPKEY], $hash=true}",
            "StreamQuery{dataSource='ssb_part', filter=InDimFilter{dimension='P_MFGR', values=[MFGR#1, MFGR#2]}, columns=[P_CATEGORY, P_PARTKEY], $hash=true}",
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='__time', values=[694224000000, 694310400000, 694396800000, 694483200000, 694569600000, 694656000000, 694742400000, 694828800000, 694915200000, 695001600000, ..2 more]} && InDimFilter{dimension='LO_CUSTKEY', values=[101, 106, 117, 121, 122, 13, 133, 14, 141, 144, ..21 more]} && InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_date]}], timeColumnName=__time}, MaterializedQuery{dataSource=[ssb_customer]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_supplier]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_part]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='S_NATION', outputName='d1'}, DefaultDimensionSpec{dimension='P_CATEGORY', outputName='d2'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_REVENUE - LO_SUPPLYCOST)', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, a0]}",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='__time', values=[694224000000, 694310400000, 694396800000, 694483200000, 694569600000, 694656000000, 694742400000, 694828800000, 694915200000, 695001600000, ..2 more]} && InDimFilter{dimension='LO_CUSTKEY', values=[101, 106, 117, 121, 122, 13, 133, 14, 141, 144, ..21 more]} && InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_date]}], timeColumnName=__time}, MaterializedQuery{dataSource=[ssb_customer]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_supplier]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
            "StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='__time', values=[694224000000, 694310400000, 694396800000, 694483200000, 694569600000, 694656000000, 694742400000, 694828800000, 694915200000, 695001600000, ..2 more]} && InDimFilter{dimension='LO_CUSTKEY', values=[101, 106, 117, 121, 122, 13, 133, 14, 141, 144, ..21 more]} && InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_date]}], timeColumnName=__time}, MaterializedQuery{dataSource=[ssb_customer]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
            "StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='__time', values=[694224000000, 694310400000, 694396800000, 694483200000, 694569600000, 694656000000, 694742400000, 694828800000, 694915200000, 695001600000, ..2 more]} && InDimFilter{dimension='LO_CUSTKEY', values=[101, 106, 117, 121, 122, 13, 133, 14, 141, 144, ..21 more]} && InDimFilter{dimension='LO_SUPPKEY', values=[1, 10, 3, 8]} && InDimFilter{dimension='LO_PARTKEY', values=[1, 10, 1000, 105, 115, 119, 120, 123, 126, 128, ..368 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}"
        );
      }
    } else {
      if (broadcastJoin) {
        hook.verifyHooked(
            "Ymo/PIw4a7UNa6G4v+AN4g==",
            "StreamQuery{dataSource='ssb_date', filter=InDimFilter{dimension='D_YEAR', values=[1992, 1993]}, columns=[D_YEAR, __time]}",
            "StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY]}",
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_NATION, S_SUPPKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_part', filter=InDimFilter{dimension='P_MFGR', values=[MFGR#1, MFGR#2]}, columns=[P_CATEGORY, P_PARTKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='S_NATION', outputName='d1'}, DefaultDimensionSpec{dimension='P_CATEGORY', outputName='d2'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_REVENUE - LO_SUPPLYCOST)', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, a0]}",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_NATION, S_SUPPKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
            "StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
            "StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}",
            "StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_NATION, S_SUPPKEY], $hash=true}",
            "StreamQuery{dataSource='ssb_part', filter=InDimFilter{dimension='P_MFGR', values=[MFGR#1, MFGR#2]}, columns=[P_CATEGORY, P_PARTKEY], $hash=true}"
        );
      } else {
        if (bloomFilter) {
          hook.verifyHooked(
              "KmUbiLdFcepel+p5qglOHA==",
              "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', filter=BloomDimFilter.Factory{bloomSource=$view:ssb_customer[C_CUSTKEY](C_REGION=='AMERICA'), fields=[DefaultDimensionSpec{dimension='LO_CUSTKEY', outputName='LO_CUSTKEY'}], groupingSets=Noop, maxNumEntries=31}, columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_date', filter=InDimFilter{dimension='D_YEAR', values=[1992, 1993]}, columns=[D_YEAR, __time], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_NATION, S_SUPPKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_part', filter=InDimFilter{dimension='P_MFGR', values=[MFGR#1, MFGR#2]}, columns=[P_CATEGORY, P_PARTKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='S_NATION', outputName='d1'}, DefaultDimensionSpec{dimension='P_CATEGORY', outputName='d2'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_REVENUE - LO_SUPPLYCOST)', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, a0]}",
              "TimeseriesQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[C_CUSTKEY], groupingSets=Noop, byRow=true, maxNumEntries=31}]}",
              "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', filter=BloomFilter{fields=[DefaultDimensionSpec{dimension='LO_CUSTKEY', outputName='LO_CUSTKEY'}], groupingSets=Noop}, columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_date', filter=InDimFilter{dimension='D_YEAR', values=[1992, 1993]}, columns=[D_YEAR, __time], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_NATION, S_SUPPKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
              "StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', filter=BloomFilter{fields=[DefaultDimensionSpec{dimension='LO_CUSTKEY', outputName='LO_CUSTKEY'}], groupingSets=Noop}, columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_date', filter=InDimFilter{dimension='D_YEAR', values=[1992, 1993]}, columns=[D_YEAR, __time], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
              "StreamQuery{dataSource='ssb_lineorder', filter=BloomFilter{fields=[DefaultDimensionSpec{dimension='LO_CUSTKEY', outputName='LO_CUSTKEY'}], groupingSets=Noop}, columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
              "StreamQuery{dataSource='ssb_date', filter=InDimFilter{dimension='D_YEAR', values=[1992, 1993]}, columns=[D_YEAR, __time], $hash=true}",
              "StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY], $hash=true}",
          ...
          hook.verifyHooked(
              "8eWPb9kxxDTstaSkw7yl6Q==",
              "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_date', filter=InDimFilter{dimension='D_YEAR', values=[1992, 1993]}, columns=[D_YEAR, __time], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_NATION, S_SUPPKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_part', filter=InDimFilter{dimension='P_MFGR', values=[MFGR#1, MFGR#2]}, columns=[P_CATEGORY, P_PARTKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='S_NATION', outputName='d1'}, DefaultDimensionSpec{dimension='P_CATEGORY', outputName='d2'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_REVENUE - LO_SUPPLYCOST)', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, a0]}",
              "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_date', filter=InDimFilter{dimension='D_YEAR', values=[1992, 1993]}, columns=[D_YEAR, __time], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_NATION, S_SUPPKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_NATION, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
              "StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, StreamQuery{dataSource='ssb_date', filter=InDimFilter{dimension='D_YEAR', values=[1992, 1993]}, columns=[D_YEAR, __time], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY], $hash=true}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
              "StreamQuery{dataSource='ssb_lineorder', columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
              "StreamQuery{dataSource='ssb_date', filter=InDimFilter{dimension='D_YEAR', values=[1992, 1993]}, columns=[D_YEAR, __time], $hash=true}",
              "StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY], $hash=true}",
              "StreamQuery{dataSource='ssb_supplier', filter=S_REGION=='AMERICA', columns=[S_NATION, S_SUPPKEY], $hash=true}",
    ...
    if (semiJoin) {
      if (broadcastJoin) {
        hook.verifyHooked(
            ...
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', filter=(LO_SUPPKEY=='10' && InDimFilter{dimension='LO_PARTKEY', values=[14, 188, 239, 255, 295, 302, 4, 414, 42, 455, ..23 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_supplier]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_CITY, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_part]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='S_CITY', outputName='d1'}, DefaultDimensionSpec{dimension='P_BRAND1', outputName='d2'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_REVENUE - LO_SUPPLYCOST)', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, a0]}",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', filter=(LO_SUPPKEY=='10' && InDimFilter{dimension='LO_PARTKEY', values=[14, 188, 239, 255, 295, 302, 4, 414, 42, 455, ..23 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_supplier]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_CITY, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
            "StreamQuery{dataSource='StreamQuery{dataSource='ssb_lineorder', filter=(LO_SUPPKEY=='10' && InDimFilter{dimension='LO_PARTKEY', values=[14, 188, 239, 255, 295, 302, 4, 414, 42, 455, ..23 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
            "StreamQuery{dataSource='ssb_lineorder', filter=(LO_SUPPKEY=='10' && InDimFilter{dimension='LO_PARTKEY', values=[14, 188, 239, 255, 295, 302, 4, 414, 42, 455, ..23 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder, leftJoinColumns=[__time], rightAlias=ssb_date, rightJoinColumns=[__time]}, hashLeft=false, hashSignature={D_YEAR:string, __time:long}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=ssb_lineorder+ssb_date, leftJoinColumns=[LO_CUSTKEY], rightAlias=ssb_customer, rightJoinColumns=[C_CUSTKEY]}, hashLeft=false, hashSignature={C_CUSTKEY:string}, applyFilter=true}]}"
        );
      } else {
        hook.verifyHooked(
            "DuF9ymeEq0DYLbVgF9XQtQ==",
            "StreamQuery{dataSource='ssb_date', filter=InDimFilter{dimension='D_YEAR', values=[1992, 1993]}, columns=[D_YEAR, __time], $hash=true}",
            "StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY], $hash=true}",
            "StreamQuery{dataSource='ssb_supplier', filter=S_NATION=='UNITED STATES', columns=[S_CITY, S_SUPPKEY], $hash=true}",
            "StreamQuery{dataSource='ssb_part', filter=P_CATEGORY=='MFGR#14', columns=[P_BRAND1, P_PARTKEY], $hash=true}",
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='__time', values=[694224000000, 694310400000, 694396800000, 694483200000, 694569600000, 694656000000, 694742400000, 694828800000, 694915200000, 695001600000, ..2 more]} && InDimFilter{dimension='LO_CUSTKEY', values=[101, 106, 117, 121, 122, 13, 133, 14, 141, 144, ..21 more]} && LO_SUPPKEY=='10' && InDimFilter{dimension='LO_PARTKEY', values=[14, 188, 239, 255, 295, 302, 4, 414, 42, 455, ..23 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_date]}], timeColumnName=__time}, MaterializedQuery{dataSource=[ssb_customer]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_supplier]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_CITY, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_part]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='D_YEAR', outputName='d0'}, DefaultDimensionSpec{dimension='S_CITY', outputName='d1'}, DefaultDimensionSpec{dimension='P_BRAND1', outputName='d2'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(LO_REVENUE - LO_SUPPLYCOST)', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, a0]}",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='__time', values=[694224000000, 694310400000, 694396800000, 694483200000, 694569600000, 694656000000, 694742400000, 694828800000, 694915200000, 695001600000, ..2 more]} && InDimFilter{dimension='LO_CUSTKEY', values=[101, 106, 117, 121, 122, 13, 133, 14, 141, 144, ..21 more]} && LO_SUPPKEY=='10' && InDimFilter{dimension='LO_PARTKEY', values=[14, 188, 239, 255, 295, 302, 4, 414, 42, 455, ..23 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_date]}], timeColumnName=__time}, MaterializedQuery{dataSource=[ssb_customer]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_supplier]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, S_CITY, S_SUPPKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
            "StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='__time', values=[694224000000, 694310400000, 694396800000, 694483200000, 694569600000, 694656000000, 694742400000, 694828800000, 694915200000, 695001600000, ..2 more]} && InDimFilter{dimension='LO_CUSTKEY', values=[101, 106, 117, 121, 122, 13, 133, 14, 141, 144, ..21 more]} && LO_SUPPKEY=='10' && InDimFilter{dimension='LO_PARTKEY', values=[14, 188, 239, 255, 295, 302, 4, 414, 42, 455, ..23 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}, MaterializedQuery{dataSource=[ssb_date]}], timeColumnName=__time}, MaterializedQuery{dataSource=[ssb_customer]}], timeColumnName=__time}', columns=[D_YEAR, __time0, C_CUSTKEY, LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}",
            "StreamQuery{dataSource='ssb_lineorder', filter=(InDimFilter{dimension='__time', values=[694224000000, 694310400000, 694396800000, 694483200000, 694569600000, 694656000000, 694742400000, 694828800000, 694915200000, 695001600000, ..2 more]} && InDimFilter{dimension='LO_CUSTKEY', values=[101, 106, 117, 121, 122, 13, 133, 14, 141, 144, ..21 more]} && LO_SUPPKEY=='10' && InDimFilter{dimension='LO_PARTKEY', values=[14, 188, 239, 255, 295, 302, 4, 414, 42, 455, ..23 more]}), columns=[LO_CUSTKEY, LO_PARTKEY, LO_REVENUE, LO_SUPPKEY, LO_SUPPLYCOST, __time]}"
        );
      }
    } else {
      if (broadcastJoin) {
        hook.verifyHooked(
            "fXOJKMZfR4beXUSeY50mYw==",
            "StreamQuery{dataSource='ssb_date', filter=InDimFilter{dimension='D_YEAR', values=[1992, 1993]}, columns=[D_YEAR, __time]}",
            "StreamQuery{dataSource='ssb_customer', filter=C_REGION=='AMERICA', columns=[C_CUSTKEY]}",
