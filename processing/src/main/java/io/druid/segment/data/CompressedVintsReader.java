...
public class CompressedVintsReader implements WritableSupplier<IntValues>
{
  ...
  {
    return maxIntsInBufferForBytes(VintValues.getNumBytesForMax(maxValue));
  }
  ...
  public Class<? extends IntValues> provides()
  {
    switch (numBytes) {
      case Byte.BYTES:
        return ByteIntValues.class;
      case Short.BYTES:
        return TwoByteIntValues.class;
      case Integer.BYTES:
        return FourByteIntValues.class;
      default:
        return ThreeByteIntValues.class;
    }
  }
  ...
  public IntValues get()
  {
    ...
    if (numBytes == Integer.BYTES) {
      return new FourByteIntValues();
    } else if (numBytes == Short.BYTES) {
      return new TwoByteIntValues();
    } else if (numBytes == 1) {
      return new ByteIntValues();
    } else {
      // default version of everything else, i.e. 3-bytes per value
      return new ThreeByteIntValues();
    }
  }
  ...
  public static CompressedVintsReader from(ByteBuffer buffer, ByteOrder order)
  {
    ...
    return new CompressedVintsReader(
        numRows,
        sizePer,
        numBytes,
        GenericIndexed.read(
  ...
  public static CompressedVintsReader fromList(
  ...
  {
    final int numBytes = VintValues.getNumBytesForMax(maxValue);
  ...
  private class FourByteIntValues extends ThreeByteIntValues
  {
  ...
  private class TwoByteIntValues extends ThreeByteIntValues
  {
  ...
  private class ByteIntValues extends ThreeByteIntValues
  {
    @Override
    protected int _get(int index)
    {
  ...
  private class ThreeByteIntValues implements IntValues
  {
    ...
    {
      return "CompressedVSizeIntValues{" +
             "currIndex=" + currIndex +
             ", sizePer=" + sizePer +
