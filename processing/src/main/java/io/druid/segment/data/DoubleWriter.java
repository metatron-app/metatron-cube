...
public class DoubleWriter implements ColumnPartWriter.DoubleType
{
  ...
  public DoubleWriter(IOPeon ioPeon, String filenameBase)
  {
    this.ioPeon = ioPeon;
  ...
  @Override
  public void add(Double obj) throws IOException
  {
  ...
  public long writeToChannel(WritableByteChannel channel) throws IOException
  {
    ...
    written += channel.write(ByteBuffer.wrap(Ints.toByteArray(Double.BYTES)));
