...
/**
 */
public class CompressedVintsSupplierTest
{
  protected List<int[]> vals;

  protected WritableSupplier<IntsValues> indexedSupplier;
  ...
  public void setUpSimple()
  {
    ...
    indexedSupplier = CompressedVintsSupplier.fromIterable(
        Iterables.transform(
            vals,
  ...
  public void testSerde() throws IOException
  {
    ...
    WritableSupplier<IntsValues> deserializedIndexed = fromByteBuffer(
  ...
  private void assertSame(List<int[]> someInts, IntsValues indexed)
  {
  ...
  {
    return CompressedVintsSupplier.from(
