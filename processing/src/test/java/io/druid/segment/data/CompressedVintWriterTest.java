...
public class CompressedVintWriterTest
{
  ...
  public CompressedVintWriterTest(
  ...
  {
    CompressedVintWriter writer = new CompressedVintWriter(
        ioPeon, "test", vals.length > 0 ? Ints.max(vals) : 0, chunkSize, byteOrder, compressionStrategy
    );
    CompressedVintsReader supplierFromList = CompressedVintsReader.fromList(
    ...
    CompressedVintsReader supplierFromByteBuffer = CompressedVintsReader.from(
