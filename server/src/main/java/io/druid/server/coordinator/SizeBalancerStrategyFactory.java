...
/**
 */
public class SizeBalancerStrategyFactory implements BalancerStrategyFactory
{
  ...
  public SizeBalancerStrategyFactory(
  ...
  {
    return new SizeBalancerStrategy(offsetPeriod, initialGrouping, baselineRatio, tolerance);
  }
}
