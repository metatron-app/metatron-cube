...
public class VIntWriterTest
{
  ...
  private void checkSerializedSizeAndData() throws Exception
  {
    ...
    VintWriter writer = new VintWriter(
        ioPeon, "test", maxValue
    );

    VintValues intsFromList = VintValues.fromList(
    ...
    VintValues intsFromByteBuffer = VintValues.readFromByteBuffer(
