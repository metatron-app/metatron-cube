...
import io.druid.segment.lucene.Lucene8ExtensionModule;
import io.druid.segment.lucene.LuceneCommonExtensionModule;
import io.druid.sql.calcite.util.TestQuerySegmentWalker;

import java.util.concurrent.Executors;

public class Lucene8TestHelper extends TestHelper
{
  ...
  static {
    ...
    for (Module module : new Lucene8ExtensionModule().getJacksonModules()) {
      mapper.registerModule(module);
    }
    ...
    segmentWalker.addIndex("estate", "estate8_schema.json", "estate.csv", true);
    segmentWalker.addIndex("estate_incremental", "estate8_schema.json", "estate.csv", false);
