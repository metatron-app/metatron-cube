...
public class CompressedIntReaderTest extends CompressionStrategyTest
{
  public CompressedIntReaderTest(CompressionStrategy compressionStrategy)
  {
    super(compressionStrategy);
  }

  private IndexedInts indexed;
  private CompressedIntReader supplier;
  private int[] vals;
  ...
  private void makeWithSerde(final int chunkSize) throws IOException
  {
    ...
    final CompressedIntReader theSupplier = fromIntBuffer(
    ...
    supplier = CompressedIntReader.from(ByteBuffer.wrap(bytes), ByteOrder.nativeOrder());
    indexed = supplier.get();
  }
  ...
  public static CompressedIntReader fromIntBuffer(
      IntBuffer buffer, int chunkFactor, ByteOrder byteOrder, CompressionStrategy compression
  )
  {
    Preconditions.checkArgument(
        chunkFactor <= CompressedIntReader.MAX_INTS_IN_BUFFER,
