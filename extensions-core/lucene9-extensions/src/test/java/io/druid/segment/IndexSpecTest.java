...
import io.druid.segment.lucene.Lucene9IndexingSpec;
...
public class IndexSpecTest
{
  ...
  {
    final ObjectMapper mapper = Lucene9TestHelper.segmentWalker.getMapper();
    final IndexSpec spec = new IndexSpec(
        null, null, null, null,
        ImmutableMap.<String, SecondaryIndexingSpec>of(
            "gis", Lucene9IndexingSpec.of(
                "standard",
    ...
    Assert.assertEquals(
        "{\"bitmap\":{\"type\":\"roaring\"},\"secondaryIndexing\":{\"gis\":{\"type\":\"lucene9\",\"textAnalyzer\":\"standard\",\"strategies\":[{\"type\":\"latlon\",\"fieldName\":\"coord\",\"latitude\":\"lat\",\"longitude\":\"lon\",\"crs\":null},{\"type\":\"text\",\"fieldName\":\"text\"}]}},\"allowNullForNumbers\":false}",
