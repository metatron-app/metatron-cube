...
public class AuthorizationUtils
{
  ...
  public static final Function<String, Iterable<ResourceAction>> DATASOURCE_READ_RAs_GENERATOR = input ->
      Collections.singletonList(new ResourceAction(new Resource(input, ResourceType.DATASOURCE), Action.READ)
  );
  ...
  public static final Function<String, Iterable<ResourceAction>> DATASOURCE_WRITE_RAs_GENERATOR = input ->
      Collections.singletonList(new ResourceAction(new Resource(input, ResourceType.DATASOURCE), Action.WRITE)
  );
}
