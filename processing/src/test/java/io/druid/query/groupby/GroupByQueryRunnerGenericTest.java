...
public class GroupByQueryRunnerGenericTest extends GroupByQueryRunnerTestHelper
{
  ...
  public void testGroupByRelay()
  {
    ...
    validate(
        query,
        array("__time", "rows", "index_min", "index_max", "index_first", "index_last"),
        array("1970-01-01", 93, 71.31593322753906, 277.2735290527344, 100.0, 106.793701171875),
        array("1970-01-01", 93, 92.5374984741211, 135.1832733154297, 100.0, 94.4697494506836),
        array("1970-01-01", 93, 84.71052551269531, 193.78756713867188, 100.0, 135.10919189453125),
        array("1970-01-01", 93, 85.06978607177734, 189.38595581054688, 100.0, 99.59690856933594),
        array("1970-01-01", 279, 91.27055358886719, 1870.06103515625, 100.0, 92.78276062011719),
        array("1970-01-01", 93, 96.0313720703125, 142.97296142578125, 100.0, 97.8597640991211),
        array("1970-01-01", 279, 99.2845230102539, 1862.7379150390625, 100.0, 120.50816345214844),
        array("1970-01-01", 93, 59.02102279663086, 119.85015106201172, 100.0, 89.64623260498047),
        array("1970-01-01", 93, 100.0, 158.73936462402344, 100.0, 120.29034423828125)
    );
  }
