...
public class TpchTest extends TpchTestHelper
{
  ...
  public void tpch15() throws Exception
  {
    ...
    if (semiJoin) {
      hook.verifyHooked(
          "mou83emyCyMKRKetTRpVaA==",
          "DimensionSamplingQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d0'}], filter=BoundDimFilter{1996-01-01 <= L_SHIPDATE < 1996-04-01(lexicographic)}, sampleRatio=0.050}",
  ...
  public void tpch20() throws Exception
  {
    ...
    if (semiJoin) {
      hook.verifyHooked(
          ...
          "DimensionSamplingQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], filter=(!(L_PARTKEY==NULL) && !(L_SUPPKEY==NULL) && BoundDimFilter{1994-01-01 <= L_SHIPDATE < 1995-01-01(lexicographic)}), sampleRatio=0.050}",
