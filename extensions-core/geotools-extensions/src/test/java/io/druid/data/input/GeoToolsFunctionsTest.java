...
public class GeoToolsFunctionsTest
{
  ...
  public void test()
  {
    double[] converted = (double[])
        Parser.parse("lonlat_to4326('EPSG:3857', -8575605.398444, 4707174.018280)").eval(null).value();
    Assert.assertArrayEquals(new double[]{-77.03597400000125, 38.89871699999715}, converted, 0.00001);

    converted = (double[])
        Parser.parse("lonlat_to4326('EPSG:4301', -77.03597400000125, 38.89871699999715)").eval(null).value();
