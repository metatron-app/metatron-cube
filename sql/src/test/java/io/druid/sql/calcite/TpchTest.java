    ...
    if (semiJoin) {
      if (broadcastJoin) {
        hook.verifyHooked(
            ...
            "StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_REGIONKEY', values=[1]}, columns=[N_NATIONKEY, N_REGIONKEY]}",
