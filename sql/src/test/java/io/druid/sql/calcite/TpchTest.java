...
public class TpchTest extends TpchTestHelper
{
  ...
  public static final Object[][] TPCH1_RESULT = {
      ...
      {"N", "F", 4654L, 6647990.519999999D, 6333568.496621376D, 6584905.261532691D, 26.0D, 37139.61184357541D, 0.048491620130878585D, 179L},
      {"N", "O", 376815L, 5.2792684456999964E8D, 5.016250502495867E8D, 5.2164760657695186E8D, 25.581466395112017D, 35840.247424983005D, 0.04984860833600234D, 14730L},
      {"R", "F", 191214L, 2.6792430413999987E8D, 2.5454761805335242E8D, 2.6480436570269588E8D, 25.673200859291086D, 35972.65093179375D, 0.04983216977656232D, 7448L}
  };
  ...
  public static final String TPCH2_EXPLAIN =
      ...
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[6], outputColumns=[2, 3, 4, 5, 6, 7, 8, 9, 1])\n"
  ...
  public static final String TPCH2_EXPLAIN_JR_S =
      "DruidOuterQueryRel(sort=[$0:DESC, $2:ASC, $1:ASC, $3:ASC], fetch=[100])\n"
    ...
    if (broadcastJoin) {
      if (semiJoin) {
        hook.verifyHooked(
            ...
            "StreamQuery{dataSource='partsupp', filter=!(PS_PARTKEY==NULL), columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_PARTKEY], rightAlias=part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_MFGR:string, P_PARTKEY:string}, applyFilter=true}}",
            "StreamQuery{dataSource='supplier', columns=[S_ACCTBAL, S_ADDRESS, S_COMMENT, S_NAME, S_NATIONKEY, S_PHONE, S_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+part, leftJoinColumns=[PS_SUPPKEY], rightAlias=supplier, rightJoinColumns=[S_SUPPKEY]}, hashLeft=true, hashSignature={PS_SUPPKEY:string, PS_SUPPLYCOST:double, P_MFGR:string, P_PARTKEY:string}, applyFilter=true}}",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='nation', filter=N_REGIONKEY=='3', columns=[N_NAME, N_NATIONKEY, N_REGIONKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+part+supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=true, hashSignature={P_MFGR:string, P_PARTKEY:string, S_ACCTBAL:double, S_ADDRESS:string, S_COMMENT:string, S_NAME:string, S_NATIONKEY:string, S_PHONE:string, PS_SUPPLYCOST:double}, applyFilter=true}, $hash=true}, GroupByQuery{dataSource='StreamQuery{dataSource='partsupp', filter=!(PS_PARTKEY==NULL), columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_SUPPKEY], rightAlias=supplier, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string, N_REGIONKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+supplier+nation, leftJoinColumns=[N_REGIONKEY], rightAlias=region, rightJoinColumns=[R_REGIONKEY]}, hashLeft=false, hashSignature={R_REGIONKEY:string}}]}', dimensions=[DefaultDimensionSpec{dimension='PS_PARTKEY', outputName='d0'}], aggregatorSpecs=[GenericMinAggregatorFactory{name='a0', fieldName='PS_SUPPLYCOST', inputType='double'}], outputColumns=[d0, a0]}], timeColumnName=__time}', columns=[S_ACCTBAL, S_NAME, N_NAME, P_PARTKEY, P_MFGR, S_ADDRESS, S_PHONE, S_COMMENT], orderingSpecs=[OrderByColumnSpec{dimension='S_ACCTBAL', direction=descending}, OrderByColumnSpec{dimension='N_NAME', direction=ascending}, OrderByColumnSpec{dimension='S_NAME', direction=ascending}, OrderByColumnSpec{dimension='P_PARTKEY', direction=ascending}], limitSpec=LimitSpec{columns=[], limit=100}}",
            ...
            "StreamQuery{dataSource='partsupp', filter=!(PS_PARTKEY==NULL), columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_SUPPKEY], rightAlias=supplier, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string, N_REGIONKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+supplier+nation, leftJoinColumns=[N_REGIONKEY], rightAlias=region, rightJoinColumns=[R_REGIONKEY]}, hashLeft=false, hashSignature={R_REGIONKEY:string}}]}",
            "StreamQuery{dataSource='nation', filter=N_REGIONKEY=='3', columns=[N_NAME, N_NATIONKEY, N_REGIONKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+part+supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=true, hashSignature={P_MFGR:string, P_PARTKEY:string, S_ACCTBAL:double, S_ADDRESS:string, S_COMMENT:string, S_NAME:string, S_NATIONKEY:string, S_PHONE:string, PS_SUPPLYCOST:double}, applyFilter=true}, $hash=true}"
        );
      } else {
        hook.verifyHooked(
            "28rTj5o3iUrqzN6Ng7R0fA==",
            "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY]}",
            "StreamQuery{dataSource='nation', columns=[N_NATIONKEY, N_REGIONKEY]}",
            "StreamQuery{dataSource='region', filter=R_NAME=='EUROPE', columns=[R_REGIONKEY]}",
            "StreamQuery{dataSource='part', filter=(P_SIZE=='37' && P_TYPE LIKE '%COPPER' && !(P_PARTKEY==NULL)), columns=[P_MFGR, P_PARTKEY]}",
            "StreamQuery{dataSource='partsupp', filter=!(PS_PARTKEY==NULL), columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_PARTKEY], rightAlias=part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_MFGR:string, P_PARTKEY:string}, applyFilter=true}}",
            "StreamQuery{dataSource='supplier', columns=[S_ACCTBAL, S_ADDRESS, S_COMMENT, S_NAME, S_NATIONKEY, S_PHONE, S_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+part, leftJoinColumns=[PS_SUPPKEY], rightAlias=supplier, rightJoinColumns=[S_SUPPKEY]}, hashLeft=true, hashSignature={PS_SUPPKEY:string, PS_SUPPLYCOST:double, P_MFGR:string, P_PARTKEY:string}, applyFilter=true}}",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='nation', columns=[N_NAME, N_NATIONKEY, N_REGIONKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+part+supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=true, hashSignature={P_MFGR:string, P_PARTKEY:string, S_ACCTBAL:double, S_ADDRESS:string, S_COMMENT:string, S_NAME:string, S_NATIONKEY:string, S_PHONE:string, PS_SUPPLYCOST:double}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+part+supplier+nation, leftJoinColumns=[N_REGIONKEY], rightAlias=region, rightJoinColumns=[R_REGIONKEY]}, hashLeft=false, hashSignature={R_REGIONKEY:string}}], $hash=true}, GroupByQuery{dataSource='StreamQuery{dataSource='partsupp', filter=!(PS_PARTKEY==NULL), columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_SUPPKEY], rightAlias=supplier, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string, N_REGIONKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+supplier+nation, leftJoinColumns=[N_REGIONKEY], rightAlias=region, rightJoinColumns=[R_REGIONKEY]}, hashLeft=false, hashSignature={R_REGIONKEY:string}}]}', dimensions=[DefaultDimensionSpec{dimension='PS_PARTKEY', outputName='d0'}], aggregatorSpecs=[GenericMinAggregatorFactory{name='a0', fieldName='PS_SUPPLYCOST', inputType='double'}], outputColumns=[d0, a0]}], timeColumnName=__time}', columns=[S_ACCTBAL, S_NAME, N_NAME, P_PARTKEY, P_MFGR, S_ADDRESS, S_PHONE, S_COMMENT], orderingSpecs=[OrderByColumnSpec{dimension='S_ACCTBAL', direction=descending}, OrderByColumnSpec{dimension='N_NAME', direction=ascending}, OrderByColumnSpec{dimension='S_NAME', direction=ascending}, OrderByColumnSpec{dimension='P_PARTKEY', direction=ascending}], limitSpec=LimitSpec{columns=[], limit=100}}",
            "GroupByQuery{dataSource='StreamQuery{dataSource='partsupp', filter=!(PS_PARTKEY==NULL), columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_SUPPKEY], rightAlias=supplier, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string, N_REGIONKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+supplier+nation, leftJoinColumns=[N_REGIONKEY], rightAlias=region, rightJoinColumns=[R_REGIONKEY]}, hashLeft=false, hashSignature={R_REGIONKEY:string}}]}', dimensions=[DefaultDimensionSpec{dimension='PS_PARTKEY', outputName='d0'}], aggregatorSpecs=[GenericMinAggregatorFactory{name='a0', fieldName='PS_SUPPLYCOST', inputType='double'}], outputColumns=[d0, a0]}",
            "StreamQuery{dataSource='partsupp', filter=!(PS_PARTKEY==NULL), columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_SUPPKEY], rightAlias=supplier, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string, N_REGIONKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+supplier+nation, leftJoinColumns=[N_REGIONKEY], rightAlias=region, rightJoinColumns=[R_REGIONKEY]}, hashLeft=false, hashSignature={R_REGIONKEY:string}}]}",
            "StreamQuery{dataSource='nation', columns=[N_NAME, N_NATIONKEY, N_REGIONKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+part+supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=true, hashSignature={P_MFGR:string, P_PARTKEY:string, S_ACCTBAL:double, S_ADDRESS:string, S_COMMENT:string, S_NAME:string, S_NATIONKEY:string, S_PHONE:string, PS_SUPPLYCOST:double}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp+part+supplier+nation, leftJoinColumns=[N_REGIONKEY], rightAlias=region, rightJoinColumns=[R_REGIONKEY]}, hashLeft=false, hashSignature={R_REGIONKEY:string}}], $hash=true}"
        );
      }
    } else {
      if (semiJoin) {
  ...
  public static final String TPCH3_EXPLAIN_JR =
      "DruidOuterQueryRel(scanProject=[$0, $1, $2, *($3, -(1, $4))], group=[{0, 1, 2}], revenue=[SUM($3)], aggregateProject=[$0, $3, $1, $2], sort=[$1:DESC, $2:ASC], fetch=[10])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[1], outputColumns=[2, 3, 5, 1, 0])\n"
      + "    DruidQueryRel(table=[druid.lineitem], scanFilter=[>($11, '1995-03-22')], scanProject=[$2, $3, $6])\n"
    ...
    if (semiJoin) {
      ...
      if (bloomFilter) {
        hook.verifyHooked(
            ...
            "StreamQuery{dataSource='orders', filter=(BoundDimFilter{O_ORDERDATE < 1995-03-22} && BloomFilter{fields=[DefaultDimensionSpec{dimension='O_CUSTKEY', outputName='O_CUSTKEY'}], groupingSets=Noop}), columns=[O_CUSTKEY, O_ORDERDATE, O_ORDERKEY, O_SHIPPRIORITY]}",
  ...
  public static final String TPCH4_EXPLAIN =
      ...
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[1])\n"
      + "    DruidQueryRel(table=[druid.orders], scanFilter=[AND(SEARCH($3, Sarg[['1996-05-01'..'1996-08-01')]:CHAR(10)), IS NOT NULL($4))], scanProject=[$4, $5])\n"
  ...
  public void tpch4() throws Exception
  {
    ...
    if (semiJoin) {
      hook.verifyHooked(
          ...
          "GroupByQuery{dataSource='StreamQuery{dataSource='orders', filter=(BoundDimFilter{1996-05-01 <= O_ORDERDATE < 1996-08-01} && !(O_ORDERKEY==NULL) && InDimFilter{dimension='O_ORDERKEY', values=[1, 100, 10016, 10017, 10018, 10019, 10020, 10021, 10022, 10023, ..6896 more]}), columns=[O_ORDERPRIORITY]}', dimensions=[DefaultDimensionSpec{dimension='O_ORDERPRIORITY', outputName='d0'}], aggregatorSpecs=[CountAggregatorFactory{name='a0'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}], limit=-1}, outputColumns=[d0, a0]}",
          "StreamQuery{dataSource='orders', filter=(BoundDimFilter{1996-05-01 <= O_ORDERDATE < 1996-08-01} && !(O_ORDERKEY==NULL) && InDimFilter{dimension='O_ORDERKEY', values=[1, 100, 10016, 10017, 10018, 10019, 10020, 10021, 10022, 10023, ..6896 more]}), columns=[O_ORDERPRIORITY]}"
      );
    } else {
      if (bloomFilter) {
        hook.verifyHooked(
            "BeDySK27n6T2qdHK5VwTAQ==",
            "DimensionSamplingQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}], filter=(MathExprFilter{expression='(L_COMMITDATE < L_RECEIPTDATE)'} && !(L_ORDERKEY==NULL)), sampleRatio=0.050}",
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='orders', filter=(BoundDimFilter{1996-05-01 <= O_ORDERDATE < 1996-08-01} && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERPRIORITY], $hash=true}, GroupByQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}], filter=(MathExprFilter{expression='(L_COMMITDATE < L_RECEIPTDATE)'} && !(L_ORDERKEY==NULL) && BloomDimFilter.Factory{bloomSource=$view:orders[O_ORDERKEY](BoundDimFilter{1996-05-01 <= O_ORDERDATE < 1996-08-01}), fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}], groupingSets=Noop, maxNumEntries=287}), outputColumns=[d0]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='O_ORDERPRIORITY', outputName='d0'}], aggregatorSpecs=[CountAggregatorFactory{name='a0'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}], limit=-1}, outputColumns=[d0, a0]}",
            ...
            "StreamQuery{dataSource='orders', filter=(BoundDimFilter{1996-05-01 <= O_ORDERDATE < 1996-08-01} && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERPRIORITY], $hash=true}",
  ...
  public static final String TPCH5_EXPLAIN =
      ...
      + "            DruidQueryRel(table=[druid.orders], scanFilter=[SEARCH($3, Sarg[['1993-01-01'..'1994-01-01')]:CHAR(10))], scanProject=[$2, $4])\n"
  ...
  public static final String TPCH5_EXPLAIN_JR =
      "DruidOuterQueryRel(scanProject=[$0, *($1, -(1, $2))], group=[{0}], REVENUE=[SUM($1)], sort=[$1:DESC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[2, 4], rightKeys=[1, 0], outputColumns=[3, 1, 0])\n"
  ...
  public static final String TPCH5_EXPLAIN_JR_S =
      "DruidOuterQueryRel(scanProject=[$0, *($1, -(1, $2))], group=[{0}], REVENUE=[SUM($1)], sort=[$1:DESC])\n"
  ...
  public void tpch5() throws Exception
  {
    ...
    if (semiJoin) {
      ...
      if (bloomFilter) {
        hook.verifyHooked(
            "8cwNKyXw9MMzcXo5vomxGg==",
            "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='customer', filter=BloomDimFilter.Factory{bloomSource=$view:orders[O_CUSTKEY](BoundDimFilter{1993-01-01 <= O_ORDERDATE < 1994-01-01}), fields=[DefaultDimensionSpec{dimension='C_CUSTKEY', outputName='C_CUSTKEY'}], groupingSets=Noop, maxNumEntries=1129}, columns=[C_CUSTKEY, C_NATIONKEY], $hash=true}, StreamQuery{dataSource='orders', filter=BoundDimFilter{1993-01-01 <= O_ORDERDATE < 1994-01-01}, columns=[O_CUSTKEY, O_ORDERKEY]}], timeColumnName=__time}, StreamQuery{dataSource='lineitem', columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', columns=[N_NAME, N_NATIONKEY, N_REGIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='region', filter=R_NAME=='AFRICA', columns=[R_REGIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='N_NAME', outputName='d0'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='a0', direction=descending}], limit=-1}, outputColumns=[d0, a0]}",
  ...
  public static final String TPCH6_EXPLAIN =
      "DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(SEARCH($11, Sarg[['1993-01-01'..'1994-01-01')]:CHAR(10)), SEARCH($2, Sarg[[0.05:DECIMAL(4, 2)..0.07:DECIMAL(4, 2)]]:DECIMAL(4, 2)), <($8, 25))], scanProject=[*($3, $2)], REVENUE=[SUM($0)])\n";
  ...
  public void tpch6() throws Exception
  {
    ...
    hook.verifyHooked(
        "CweYxhtU6/v5anbL9dCHMw==",
        "TimeseriesQuery{dataSource='lineitem', filter=(BoundDimFilter{1993-01-01 <= L_SHIPDATE < 1994-01-01} && BoundDimFilter{0.05 <= L_DISCOUNT <= 0.07(numeric)} && BoundDimFilter{L_QUANTITY < 25(numeric)}), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(L_EXTENDEDPRICE * L_DISCOUNT)', inputType='double'}], outputColumns=[a0]}"
    );
  }
  ...
  public static final String TPCH7_EXPLAIN =
      ...
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[1], outputColumns=[3, 5, 4, 1, 0])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[1], outputColumns=[1, 2, 3, 5, 4])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[0], outputColumns=[0, 1, 2, 6, 4])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[1], outputColumns=[0, 1, 2, 5, 4])\n"
      + "          DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[3], outputColumns=[0, 2, 3, 4, 6])\n"
      + "            DruidQueryRel(table=[druid.supplier], scanProject=[$4, $6])\n"
      + "            DruidQueryRel(table=[druid.lineitem], scanFilter=[SEARCH($11, Sarg[['1995-01-01'..'1996-12-31']]:CHAR(10))], scanProject=[$2, $3, $6, $14, YEAR($11)])\n"
      + "          DruidQueryRel(table=[druid.orders], scanProject=[$2, $4])\n"
      + "        DruidQueryRel(table=[druid.customer], scanProject=[$3, $6])\n"
      + "      DruidQueryRel(table=[druid.nation], scanFilter=[SEARCH($1, Sarg['KENYA':VARCHAR(5), 'PERU':VARCHAR(5)]:VARCHAR(5))], scanProject=[$1, $2])\n"
      + "    DruidQueryRel(table=[druid.nation], scanFilter=[SEARCH($1, Sarg['KENYA':VARCHAR(5), 'PERU':VARCHAR(5)]:VARCHAR(5))], scanProject=[$1, $2])\n";

  public static final String TPCH7_EXPLAIN_JR =
      "DruidOuterQueryRel(scanFilter=[OR(AND(=($0, 'KENYA'), =($1, 'PERU')), AND(=($0, 'PERU'), =($1, 'KENYA')))], scanProject=[$0, $1, $2, *($3, -(1, $4))], group=[{0, 1, 2}], REVENUE=[SUM($3)], sort=[$0:ASC, $1:ASC, $2:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[0], outputColumns=[3, 6, 4, 1, 0])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[0], outputColumns=[0, 1, 2, 6, 4])\n"
      + "      DruidQueryRel(table=[druid.lineitem], scanFilter=[SEARCH($11, Sarg[['1995-01-01'..'1996-12-31']]:CHAR(10))], scanProject=[$2, $3, $6, $14, YEAR($11)])\n"
  ...
  public void tpch7() throws Exception
  {
    ...
    if (semiJoin) {
      ...
      if (broadcastJoin) {
        if (bloomFilter) {
          hook.verifyHooked(
              "CMmkEGciBwBN5Rc4R91rRg==",
              "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY]}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=BoundDimFilter{1995-01-01 <= L_SHIPDATE <= 1996-12-31}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_SUPPKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(L_SHIPDATE)', outputName='v0'}], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=BloomDimFilter.Factory{bloomSource=$view:lineitem[L_ORDERKEY]([ExprVirtualColumn{expression='YEAR(L_SHIPDATE)', outputName='v0'}])(BoundDimFilter{1995-01-01 <= L_SHIPDATE <= 1996-12-31}), fields=[DefaultDimensionSpec{dimension='O_ORDERKEY', outputName='O_ORDERKEY'}], groupingSets=Noop, maxNumEntries=9068}, columns=[O_CUSTKEY, O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='customer', columns=[C_CUSTKEY, C_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}, columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}, columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='N_NAME', outputName='d0'}, DefaultDimensionSpec{dimension='N_NAME0', outputName='d1'}, DefaultDimensionSpec{dimension='v0', outputName='d2'}], filter=(InDimFilter{dimension='N_NAME', values=[KENYA, PERU]} && (N_NAME0=='PERU' || N_NAME=='PERU') && (N_NAME=='KENYA' || N_NAME0=='KENYA') && InDimFilter{dimension='N_NAME0', values=[KENYA, PERU]}), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, a0]}",
              "TimeseriesQuery{dataSource='lineitem', filter=BoundDimFilter{1995-01-01 <= L_SHIPDATE <= 1996-12-31}, aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[L_ORDERKEY], groupingSets=Noop, byRow=true, maxNumEntries=9068}]}",
          ...
          hook.verifyHooked(
              "kUfRRQnH5OCoEYibFgFL/Q==",
              "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY]}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=BoundDimFilter{1995-01-01 <= L_SHIPDATE <= 1996-12-31}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_SUPPKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(L_SHIPDATE)', outputName='v0'}], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', columns=[O_CUSTKEY, O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='customer', columns=[C_CUSTKEY, C_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}, columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}, columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='N_NAME', outputName='d0'}, DefaultDimensionSpec{dimension='N_NAME0', outputName='d1'}, DefaultDimensionSpec{dimension='v0', outputName='d2'}], filter=(InDimFilter{dimension='N_NAME', values=[KENYA, PERU]} && (N_NAME0=='PERU' || N_NAME=='PERU') && (N_NAME=='KENYA' || N_NAME0=='KENYA') && InDimFilter{dimension='N_NAME0', values=[KENYA, PERU]}), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, a0]}",
              "StreamQuery{dataSource='lineitem', filter=BoundDimFilter{1995-01-01 <= L_SHIPDATE <= 1996-12-31}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_SUPPKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(L_SHIPDATE)', outputName='v0'}], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}",
              "StreamQuery{dataSource='orders', columns=[O_CUSTKEY, O_ORDERKEY], $hash=true}",
              "StreamQuery{dataSource='customer', columns=[C_CUSTKEY, C_NATIONKEY], $hash=true}",
              "StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}, columns=[N_NAME, N_NATIONKEY], $hash=true}",
        ...
        if (bloomFilter) {
          hook.verifyHooked(
              "GUP0bZv6mJGJDQBwHRMNTQ==",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=BloomDimFilter.Factory{bloomSource=$view:nation[N_NATIONKEY](InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}), fields=[DefaultDimensionSpec{dimension='S_NATIONKEY', outputName='S_NATIONKEY'}], groupingSets=Noop, maxNumEntries=2}, columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=BoundDimFilter{1995-01-01 <= L_SHIPDATE <= 1996-12-31}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_SUPPKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(L_SHIPDATE)', outputName='v0'}]}], timeColumnName=__time}, StreamQuery{dataSource='orders', columns=[O_CUSTKEY, O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='customer', columns=[C_CUSTKEY, C_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}, columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}, columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='N_NAME', outputName='d0'}, DefaultDimensionSpec{dimension='N_NAME0', outputName='d1'}, DefaultDimensionSpec{dimension='v0', outputName='d2'}], filter=(InDimFilter{dimension='N_NAME', values=[KENYA, PERU]} && (N_NAME0=='PERU' || N_NAME=='PERU') && (N_NAME=='KENYA' || N_NAME0=='KENYA') && InDimFilter{dimension='N_NAME0', values=[KENYA, PERU]}), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, a0]}",
              ...
              "StreamQuery{dataSource='lineitem', filter=BoundDimFilter{1995-01-01 <= L_SHIPDATE <= 1996-12-31}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_SUPPKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(L_SHIPDATE)', outputName='v0'}]}",
              "StreamQuery{dataSource='orders', columns=[O_CUSTKEY, O_ORDERKEY], $hash=true}",
              "StreamQuery{dataSource='customer', columns=[C_CUSTKEY, C_NATIONKEY], $hash=true}",
              "StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}, columns=[N_NAME, N_NATIONKEY], $hash=true}",
              "StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}, columns=[N_NAME, N_NATIONKEY], $hash=true}"
          ...
          hook.verifyHooked(
              "YR7pg7WqfubNUOQZdh4f5g==",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=BoundDimFilter{1995-01-01 <= L_SHIPDATE <= 1996-12-31}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_SUPPKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(L_SHIPDATE)', outputName='v0'}]}], timeColumnName=__time}, StreamQuery{dataSource='orders', columns=[O_CUSTKEY, O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='customer', columns=[C_CUSTKEY, C_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}, columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=InDimFilter{dimension='N_NAME', values=[KENYA, PERU]}, columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='N_NAME', outputName='d0'}, DefaultDimensionSpec{dimension='N_NAME0', outputName='d1'}, DefaultDimensionSpec{dimension='v0', outputName='d2'}], filter=(InDimFilter{dimension='N_NAME', values=[KENYA, PERU]} && (N_NAME0=='PERU' || N_NAME=='PERU') && (N_NAME=='KENYA' || N_NAME0=='KENYA') && InDimFilter{dimension='N_NAME0', values=[KENYA, PERU]}), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, a0]}",
              "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=BoundDimFilter{1995-01-01 <= L_SHIPDATE <= 1996-12-31}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_SUPPKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(L_SHIPDATE)', outputName='v0'}]}",
              "StreamQuery{dataSource='orders', columns=[O_CUSTKEY, O_ORDERKEY], $hash=true}",
              "StreamQuery{dataSource='customer', columns=[C_CUSTKEY, C_NATIONKEY], $hash=true}",
  ...
  public static final String TPCH8_EXPLAIN =
      "DruidOuterQueryRel(scanProject=[$0, CASE(=($1, 'ROMANIA'), *($2, -(1, $3)), 0:DOUBLE), *($2, -(1, $3))], group=[{0}], agg#0=[SUM($1)], agg#1=[SUM($2)], aggregateProject=[$0, /($1, $2)], sort=[$0:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[0], outputColumns=[4, 3, 1, 0])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[1], outputColumns=[1, 2, 3, 5, 4])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[0], outputColumns=[0, 1, 2, 6, 4])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[0], outputColumns=[0, 1, 2, 6, 4])\n"
      + "          DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[1], outputColumns=[0, 1, 2, 4, 6])\n"
      + "            DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[1], outputColumns=[4, 0, 1, 2])\n"
      ...
      + "              DruidQueryRel(table=[druid.supplier], scanProject=[$4, $6])\n"
      + "            DruidQueryRel(table=[druid.orders], scanFilter=[SEARCH($3, Sarg[['1995-01-01'..'1996-12-31']]:CHAR(10))], scanProject=[$2, $4, YEAR($3)])\n"
      + "          DruidQueryRel(table=[druid.customer], scanProject=[$3, $6])\n"
      + "        DruidQueryRel(table=[druid.nation], scanProject=[$2, $3])\n"
  ...
  public static final String TPCH8_EXPLAIN_JR =
      "DruidOuterQueryRel(scanProject=[$0, CASE(=($1, 'ROMANIA'), *($2, -(1, $3)), 0:DOUBLE), *($2, -(1, $3))], group=[{0}], agg#0=[SUM($1)], agg#1=[SUM($2)], aggregateProject=[$0, /($1, $2)], sort=[$0:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[2], outputColumns=[1, 5, 3, 2])\n"
  ...
  public static final String TPCH8_EXPLAIN_JR2 =
      "DruidOuterQueryRel(scanProject=[$0, CASE(=($1, 'ROMANIA'), *($2, -(1, $3)), 0:DOUBLE), *($2, -(1, $3))], group=[{0}], agg#0=[SUM($1)], agg#1=[SUM($2)], aggregateProject=[$0, /($1, $2)], sort=[$0:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[4, 3, 2, 1])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[2], outputColumns=[0, 3, 4, 6, 2])\n"
      + "      DruidQueryRel(table=[druid.orders], scanFilter=[SEARCH($3, Sarg[['1995-01-01'..'1996-12-31']]:CHAR(10))], scanProject=[$2, $4, YEAR($3)])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[0], outputColumns=[0, 1, 2, 5])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[0], outputColumns=[0, 1, 2, 4])\n"
      + "          DruidQueryRel(table=[druid.lineitem], scanProject=[$2, $3, $6, $7, $14])\n"
  ...
  public void tpch8() throws Exception
  {
    ...
    if (semiJoin) {
      if (broadcastJoin) {
        hook.verifyHooked(
            "ZvRqiBEUbvBqLTwepBJhPQ==",
            "StreamQuery{dataSource='part', filter=P_TYPE=='ECONOMY BURNISHED NICKEL', columns=[P_PARTKEY]}",
            "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY]}",
            "StreamQuery{dataSource='lineitem', filter=InDimFilter{dimension='L_PARTKEY', values=[215, 345, 349, 51, 53, 666, 722]}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem+part, leftJoinColumns=[L_SUPPKEY], rightAlias=supplier, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, $hash=true}",
            "StreamQuery{dataSource='nation', columns=[N_NATIONKEY, N_REGIONKEY], $hash=true}",
        ...
        hook.verifyHooked(
            "BKMnKTYcdmTyZzx0Laa+hQ==",
            "StreamQuery{dataSource='part', filter=P_TYPE=='ECONOMY BURNISHED NICKEL', columns=[P_PARTKEY]}",
            "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}",
            "StreamQuery{dataSource='nation', columns=[N_NATIONKEY, N_REGIONKEY], $hash=true}",
            "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(InDimFilter{dimension='L_PARTKEY', values=[215, 345, 349, 51, 53, 666, 722]} && InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]}), columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_SUPPKEY]}, MaterializedQuery{dataSource=[supplier]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=BoundDimFilter{1995-01-01 <= O_ORDERDATE <= 1996-12-31}, columns=[O_CUSTKEY, O_ORDERKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(O_ORDERDATE)', outputName='v0'}]}], timeColumnName=__time}, StreamQuery{dataSource='customer', filter=InDimFilter{dimension='C_NATIONKEY', values=[0, 1, 10, 11, 12, 13, 14, 15, 16, 17, ..15 more]}, columns=[C_CUSTKEY, C_NATIONKEY]}], timeColumnName=__time}, MaterializedQuery{dataSource=[nation]}], timeColumnName=__time}, StreamQuery{dataSource='nation', columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='region', filter=R_NAME=='AMERICA', columns=[R_REGIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='v0', outputName='d0'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='case((N_NAME == 'ROMANIA'),(L_EXTENDEDPRICE * (1 - L_DISCOUNT)),0.0D)', inputType='double'}, GenericSumAggregatorFactory{name='a1', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='(a0 / a1)', finalize=true}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}], limit=-1}, outputColumns=[d0, p0]}",
            "StreamQuery{dataSource='lineitem', filter=(InDimFilter{dimension='L_PARTKEY', values=[215, 345, 349, 51, 53, 666, 722]} && InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]}), columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_SUPPKEY]}",
  ...
  public static final String TPCH9_EXPLAIN =
      "DruidOuterQueryRel(scanProject=[$0, $1, -(*($2, -(1, $3)), *($4, $5))], group=[{0, 1}], SUM_PROFIT=[SUM($2)], sort=[$0:ASC, $1:DESC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[1], outputColumns=[6, 5, 2, 1, 4, 3])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[0], outputColumns=[0, 1, 2, 4, 5, 7])\n"
      ...
      + "          DruidJoinRel(joinType=[INNER], leftKeys=[5], rightKeys=[1], outputColumns=[0, 1, 2, 3, 4, 5, 6])\n"
      ...
      + "      DruidQueryRel(table=[druid.orders], scanProject=[$4, YEAR($3)])\n"
      + "    DruidQueryRel(table=[druid.nation], scanProject=[$1, $2])\n";

  public static final String TPCH9_EXPLAIN_JR =
      "DruidOuterQueryRel(scanProject=[$0, $1, -(*($2, -(1, $3)), *($4, $5))], group=[{0, 1}], SUM_PROFIT=[SUM($2)], sort=[$0:ASC, $1:DESC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[3], outputColumns=[7, 1, 4, 3, 2, 6])\n"
      + "    DruidQueryRel(table=[druid.orders], scanProject=[$4, YEAR($3)])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[1, 0], rightKeys=[5, 3], outputColumns=[2, 3, 4, 5, 7, 9])\n"
      + "      DruidQueryRel(table=[druid.partsupp], scanProject=[$2, $3, $4])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[5], rightKeys=[0], outputColumns=[0, 1, 2, 3, 4, 5, 7])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[0], outputColumns=[0, 1, 2, 3, 4, 5])\n"
      + "          DruidQueryRel(table=[druid.lineitem], scanProject=[$2, $3, $6, $7, $8, $14])\n"
      + "          DruidQueryRel(table=[druid.part], scanFilter=[LIKE($4, '%plum%')], scanProject=[$5])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[1], outputColumns=[1, 2])\n"
      + "          DruidQueryRel(table=[druid.supplier], scanProject=[$4, $6])\n"
  ...
  public void tpch9() throws Exception
  {
    ...
    if (semiJoin) {
      if (broadcastJoin) {
        ...
        hook.verifyHooked(
            "gye3q1AgGtIwZjd4JocwlQ==",
            "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}",
            "StreamQuery{dataSource='part', filter=P_NAME LIKE '%plum%', columns=[P_PARTKEY]}",
            "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]} && InDimFilter{dimension='L_PARTKEY', values=[104, 118, 181, 186, 194, 209, 219, 263, 264, 275, ..39 more]}), columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_PARTKEY, L_QUANTITY, L_SUPPKEY]}, MaterializedQuery{dataSource=[supplier]}], timeColumnName=__time}, StreamQuery{dataSource='partsupp', columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST]}], timeColumnName=__time}, StreamQuery{dataSource='orders', columns=[O_ORDERKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(O_ORDERDATE)', outputName='v0'}]}], timeColumnName=__time}, StreamQuery{dataSource='nation', columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='N_NAME', outputName='d0'}, DefaultDimensionSpec{dimension='v0', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='((L_EXTENDEDPRICE * (1 - L_DISCOUNT)) - (PS_SUPPLYCOST * L_QUANTITY))', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=descending}], limit=-1}, outputColumns=[d0, d1, a0]}",
      ...
      if (broadcastJoin) {
        hook.verifyHooked(
            "vxZw18508Cts+z5SLM+kiQ==",
            "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY]}",
            "StreamQuery{dataSource='part', filter=P_NAME LIKE '%plum%', columns=[P_PARTKEY]}",
            "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_PARTKEY, L_QUANTITY, L_SUPPKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_SUPPKEY], rightAlias=supplier, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem+supplier, leftJoinColumns=[L_PARTKEY], rightAlias=part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_PARTKEY:string}, applyFilter=true}], $hash=true}, StreamQuery{dataSource='partsupp', columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST]}], timeColumnName=__time}, StreamQuery{dataSource='orders', columns=[O_ORDERKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(O_ORDERDATE)', outputName='v0'}]}], timeColumnName=__time}, StreamQuery{dataSource='nation', columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='N_NAME', outputName='d0'}, DefaultDimensionSpec{dimension='v0', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='((L_EXTENDEDPRICE * (1 - L_DISCOUNT)) - (PS_SUPPLYCOST * L_QUANTITY))', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=descending}], limit=-1}, outputColumns=[d0, d1, a0]}",
            "StreamQuery{dataSource='lineitem', columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_PARTKEY, L_QUANTITY, L_SUPPKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_SUPPKEY], rightAlias=supplier, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem+supplier, leftJoinColumns=[L_PARTKEY], rightAlias=part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_PARTKEY:string}, applyFilter=true}], $hash=true}",
            "StreamQuery{dataSource='partsupp', columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST]}",
            "StreamQuery{dataSource='orders', columns=[O_ORDERKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(O_ORDERDATE)', outputName='v0'}]}",
            "StreamQuery{dataSource='nation', columns=[N_NAME, N_NATIONKEY], $hash=true}"
        );
        ...
        if (bloomFilter) {
          hook.verifyHooked(
              "AEl5iuMxLEGJ9SghekXw3w==",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=BloomDimFilter.Factory{bloomSource=$view:part[P_PARTKEY](P_NAME LIKE '%plum%'), fields=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='L_PARTKEY'}], groupingSets=Noop, maxNumEntries=49}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_PARTKEY, L_QUANTITY, L_SUPPKEY]}, StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='part', filter=P_NAME LIKE '%plum%', columns=[P_PARTKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='partsupp', columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST]}], timeColumnName=__time}, StreamQuery{dataSource='orders', columns=[O_ORDERKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(O_ORDERDATE)', outputName='v0'}]}], timeColumnName=__time}, StreamQuery{dataSource='nation', columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='N_NAME', outputName='d0'}, DefaultDimensionSpec{dimension='v0', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='((L_EXTENDEDPRICE * (1 - L_DISCOUNT)) - (PS_SUPPLYCOST * L_QUANTITY))', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=descending}], limit=-1}, outputColumns=[d0, d1, a0]}",
          ...
          hook.verifyHooked(
              "CbJGp09FVr0aZUuBQba6jA==",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY, L_PARTKEY, L_QUANTITY, L_SUPPKEY]}, StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='part', filter=P_NAME LIKE '%plum%', columns=[P_PARTKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='partsupp', columns=[PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST]}], timeColumnName=__time}, StreamQuery{dataSource='orders', columns=[O_ORDERKEY, v0], virtualColumns=[ExprVirtualColumn{expression='YEAR(O_ORDERDATE)', outputName='v0'}]}], timeColumnName=__time}, StreamQuery{dataSource='nation', columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='N_NAME', outputName='d0'}, DefaultDimensionSpec{dimension='v0', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='((L_EXTENDEDPRICE * (1 - L_DISCOUNT)) - (PS_SUPPLYCOST * L_QUANTITY))', inputType='double'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=descending}], limit=-1}, outputColumns=[d0, d1, a0]}",
  ...
  public static final String TPCH10_EXPLAIN =
      ...
      + "        DruidQueryRel(table=[druid.orders], scanFilter=[SEARCH($3, Sarg[['1993-07-01'..'1993-10-01')]:CHAR(10))], scanProject=[$2, $4])\n"
      + "      DruidQueryRel(table=[druid.lineitem], scanFilter=[=($10, 'R')], scanProject=[$2, $3, $6])\n"
      + "    DruidQueryRel(table=[druid.nation], scanProject=[$1, $2])\n";

  public static final String TPCH10_EXPLAIN_JR =
      "DruidOuterQueryRel(scanProject=[$0, $1, $2, $3, $4, $5, $6, *($7, -(1, $8))], group=[{0, 1, 2, 3, 4, 5, 6}], REVENUE=[SUM($7)], aggregateProject=[$0, $1, $7, $2, $4, $5, $3, $6], sort=[$2:DESC], fetch=[20])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[3], outputColumns=[6, 7, 3, 8, 9, 4, 5, 2, 1])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[2], outputColumns=[0, 2, 3])\n"
      + "      DruidQueryRel(table=[druid.orders], scanFilter=[SEARCH($3, Sarg[['1993-07-01'..'1993-10-01')]:CHAR(10))], scanProject=[$2, $4])\n"
      + "      DruidQueryRel(table=[druid.lineitem], scanFilter=[=($10, 'R')], scanProject=[$2, $3, $6])\n"
    ...
    if (semiJoin) {
      ...
      if (bloomFilter) {
        hook.verifyHooked(
            ...
            "StreamQuery{dataSource='customer', filter=BloomFilter{fields=[DefaultDimensionSpec{dimension='C_CUSTKEY', outputName='C_CUSTKEY'}], groupingSets=Noop}, columns=[C_ACCTBAL, C_ADDRESS, C_COMMENT, C_CUSTKEY, C_NAME, C_NATIONKEY, C_PHONE], $hash=true}",
            "StreamQuery{dataSource='orders', filter=BoundDimFilter{1993-07-01 <= O_ORDERDATE < 1993-10-01}, columns=[O_CUSTKEY, O_ORDERKEY]}",
            "StreamQuery{dataSource='lineitem', filter=L_RETURNFLAG=='R', columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_ORDERKEY]}",
            "StreamQuery{dataSource='nation', columns=[N_NAME, N_NATIONKEY], $hash=true}"
        );
      } else {
  ...
  public static final String TPCH11_EXPLAIN =
      ...
      + "  DruidJoinRel(joinType=[INNER], outputColumns=[0, 1, 2])\n"
  ...
  public static final String TPCH12_EXPLAIN =
      "DruidOuterQueryRel(scanProject=[$0, IS TRUE(SEARCH($1, Sarg['1-URGENT':VARCHAR(8), '2-HIGH':VARCHAR(8)]:VARCHAR(8))), IS TRUE(SEARCH($1, Sarg[(-∞..'1-URGENT':VARCHAR(8)), ('1-URGENT':VARCHAR(8)..'2-HIGH':VARCHAR(8)), ('2-HIGH':VARCHAR(8)..+∞)]:VARCHAR(8)))], group=[{0}], high_line_count=[COUNT() FILTER $1], low_line_count=[COUNT() FILTER $2], sort=[$0:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[3, 1])\n"
      + "    DruidQueryRel(table=[druid.orders], scanProject=[$4, $5])\n"
      + "    DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(SEARCH($13, Sarg['MAIL':VARCHAR(7), 'REG AIR':VARCHAR(7)]:VARCHAR(7)), <($1, $9), <($11, $1), SEARCH($9, Sarg[['1995-01-01'..'1996-01-01')]:CHAR(10)))], scanProject=[$6, $13])\n";
  ...
  public static final String TPCH14_EXPLAIN =
      "DruidOuterQueryRel(scanProject=[CASE($0, *($1, -(1, $2)), 0:DOUBLE), *($1, -(1, $2))], agg#0=[SUM($0)], agg#1=[SUM($1)], aggregateProject=[/(*(100.00:DECIMAL(5, 2), $0), $1)])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[0], outputColumns=[4, 1, 0])\n"
      + "    DruidQueryRel(table=[druid.lineitem], scanFilter=[SEARCH($11, Sarg[['1995-08-01'..'1995-09-01')]:CHAR(10))], scanProject=[$2, $3, $7])\n"
      + "    DruidQueryRel(table=[druid.part], scanProject=[$5, LIKE($8, 'PROMO%')])\n";
  ...
  public void tpch14() throws Exception
  {
    ...
    if (semiJoin) {
      hook.verifyHooked(
          ...
          "TimeseriesQuery{dataSource='CommonJoin{queries=[MaterializedQuery{dataSource=[lineitem]}, StreamQuery{dataSource='part', filter=InDimFilter{dimension='P_PARTKEY', values=[102, 107, 109, 11, 110, 113, 12, 123, 124, 125, ..335 more]}, columns=[P_PARTKEY, v0], virtualColumns=[ExprVirtualColumn{expression='like(P_TYPE,'PROMO%')', outputName='v0'}]}], timeColumnName=__time}', aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='case(v0,(L_EXTENDEDPRICE * (1 - L_DISCOUNT)),0.0D)', inputType='double'}, GenericSumAggregatorFactory{name='a1', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='((100.00B * a0) / a1)', finalize=true}], outputColumns=[p0]}",
          "StreamQuery{dataSource='part', filter=InDimFilter{dimension='P_PARTKEY', values=[102, 107, 109, 11, 110, 113, 12, 123, 124, 125, ..335 more]}, columns=[P_PARTKEY, v0], virtualColumns=[ExprVirtualColumn{expression='like(P_TYPE,'PROMO%')', outputName='v0'}]}"
      );
    } else {
      if (bloomFilter) {
        hook.verifyHooked(
            "Ya6cIqG9YBNvXMIrhRqwwQ==",
            "TimeseriesQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=BoundDimFilter{1995-08-01 <= L_SHIPDATE < 1995-09-01}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY]}, StreamQuery{dataSource='part', filter=BloomDimFilter.Factory{bloomSource=$view:lineitem[L_PARTKEY](BoundDimFilter{1995-08-01 <= L_SHIPDATE < 1995-09-01}), fields=[DefaultDimensionSpec{dimension='P_PARTKEY', outputName='P_PARTKEY'}], groupingSets=Noop, maxNumEntries=408}, columns=[P_PARTKEY, v0], virtualColumns=[ExprVirtualColumn{expression='like(P_TYPE,'PROMO%')', outputName='v0'}], $hash=true}], timeColumnName=__time}', aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='case(v0,(L_EXTENDEDPRICE * (1 - L_DISCOUNT)),0.0D)', inputType='double'}, GenericSumAggregatorFactory{name='a1', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='((100.00B * a0) / a1)', finalize=true}], outputColumns=[p0]}",
            ...
            "StreamQuery{dataSource='lineitem', filter=BoundDimFilter{1995-08-01 <= L_SHIPDATE < 1995-09-01}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY]}",
            "StreamQuery{dataSource='part', filter=BloomFilter{fields=[DefaultDimensionSpec{dimension='P_PARTKEY', outputName='P_PARTKEY'}], groupingSets=Noop}, columns=[P_PARTKEY, v0], virtualColumns=[ExprVirtualColumn{expression='like(P_TYPE,'PROMO%')', outputName='v0'}], $hash=true}"
        );
      } else {
        hook.verifyHooked(
            "1D6TTNj13KV6pZ/cfdQ1xg==",
            "TimeseriesQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=BoundDimFilter{1995-08-01 <= L_SHIPDATE < 1995-09-01}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY], $hash=true}, StreamQuery{dataSource='part', columns=[P_PARTKEY, v0], virtualColumns=[ExprVirtualColumn{expression='like(P_TYPE,'PROMO%')', outputName='v0'}]}], timeColumnName=__time}', aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='case(v0,(L_EXTENDEDPRICE * (1 - L_DISCOUNT)),0.0D)', inputType='double'}, GenericSumAggregatorFactory{name='a1', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='((100.00B * a0) / a1)', finalize=true}], outputColumns=[p0]}",
            "StreamQuery{dataSource='lineitem', filter=BoundDimFilter{1995-08-01 <= L_SHIPDATE < 1995-09-01}, columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY], $hash=true}",
            "StreamQuery{dataSource='part', columns=[P_PARTKEY, v0], virtualColumns=[ExprVirtualColumn{expression='like(P_TYPE,'PROMO%')', outputName='v0'}]}"
        );
      }
    }
  }
  ...
  public static final String TPCH15_EXPLAIN =
      ...
      + "      DruidQueryRel(table=[druid.lineitem], scanFilter=[SEARCH($11, Sarg[['1996-01-01'..'1996-04-01')]:CHAR(10))], scanProject=[$14, *($3, -(1, $2))], group=[{0}], TOTAL_REVENUE=[SUM($1)])\n"
      + "    DruidOuterQueryRel(EXPR$0=[MAX($0)])\n"
      + "      DruidQueryRel(table=[druid.lineitem], scanFilter=[SEARCH($11, Sarg[['1996-01-01'..'1996-04-01')]:CHAR(10))], scanProject=[$14, *($3, -(1, $2))], group=[{0}], TOTAL_REVENUE=[SUM($1)], aggregateProject=[$1])\n";

  public static final String TPCH15_EXPLAIN_JR =
      "DruidOuterQueryRel(sort=[$0:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[0], outputColumns=[3, 1, 0, 2, 5])\n"
      + "    DruidQueryRel(table=[druid.supplier], scanProject=[$1, $3, $5, $6])\n"
  ...
  public static final String TPCH15_EXPLAIN_JR2 =
      "DruidOuterQueryRel(sort=[$0:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[4], rightKeys=[0], outputColumns=[3, 1, 0, 2, 4])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[0], outputColumns=[0, 1, 2, 3, 5])\n"
      + "      DruidQueryRel(table=[druid.supplier], scanProject=[$1, $3, $5, $6])\n"
  ...
  public static final String TPCH16_EXPLAIN =
      ...
      + "  DruidJoinRel(joinType=[LEFT], leftKeys=[0], rightKeys=[0], outputColumns=[1, 3, 2, 0, 4, 7, 5])\n"
      + "    DruidJoinRel(joinType=[INNER], outputColumns=[0, 1, 2, 3, 4, 5])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[1], outputColumns=[1, 2, 4, 5])\n"
      + "        DruidQueryRel(table=[druid.partsupp], scanProject=[$2, $3])\n"
      + "        DruidQueryRel(table=[druid.part], scanFilter=[AND(<>($0, 'Brand#34'), SEARCH($7, Sarg[14L:BIGINT, 21L:BIGINT, 22L:BIGINT, 27L:BIGINT, 28L:BIGINT, 33L:BIGINT, 35L:BIGINT, 49L:BIGINT]:BIGINT), NOT(LIKE($8, 'ECONOMY BRUSHED%')))], scanProject=[$0, $5, $7, $8])\n"
      + "      DruidQueryRel(table=[druid.supplier], scanFilter=[LIKE($2, '%fluffily%requests%')], scanProject=[$6], c=[COUNT()], ck=[COUNT($0)])\n"
      + "    DruidQueryRel(table=[druid.supplier], scanFilter=[LIKE($2, '%fluffily%requests%')], scanProject=[$6], group=[{0}], i=[LITERAL_AGG(true)])\n";

  public static final String TPCH16_EXPLAIN_JR =
      "DruidOuterQueryRel(scanFilter=[OR(=($4, 0), AND(IS NULL($5), >=($6, $4), IS NOT NULL($3)))], scanProject=[$0, $1, $2, $3], group=[{0, 1, 2}], supplier_cnt=[COUNT(DISTINCT $3)], sort=[$3:DESC, $0:ASC, $1:ASC, $2:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], outputColumns=[1, 3, 2, 0, 5, 4, 6])\n"
      + "    DruidJoinRel(joinType=[LEFT], leftKeys=[0], rightKeys=[0], outputColumns=[0, 1, 2, 3, 5])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[1], outputColumns=[1, 2, 4, 5])\n"
      + "        DruidQueryRel(table=[druid.partsupp], scanProject=[$2, $3])\n"
      + "        DruidQueryRel(table=[druid.part], scanFilter=[AND(<>($0, 'Brand#34'), SEARCH($7, Sarg[14L:BIGINT, 21L:BIGINT, 22L:BIGINT, 27L:BIGINT, 28L:BIGINT, 33L:BIGINT, 35L:BIGINT, 49L:BIGINT]:BIGINT), NOT(LIKE($8, 'ECONOMY BRUSHED%')))], scanProject=[$0, $5, $7, $8])\n"
      + "      DruidQueryRel(table=[druid.supplier], scanFilter=[LIKE($2, '%fluffily%requests%')], scanProject=[$6], group=[{0}], i=[LITERAL_AGG(true)])\n"
  ...
  public void tpch16() throws Exception
  {
    ...
    if (semiJoin) {
      hook.verifyHooked(
          ...
          "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='partsupp', filter=InDimFilter{dimension='PS_PARTKEY', values=[105, 106, 111, 116, 127, 134, 14, 150, 155, 162, ..139 more]}, columns=[PS_PARTKEY, PS_SUPPKEY]}, MaterializedQuery{dataSource=[part]}], timeColumnName=__time}, TimeseriesQuery{dataSource='supplier', filter=S_COMMENT LIKE '%fluffily%requests%', aggregatorSpecs=[CountAggregatorFactory{name='a0'}, CountAggregatorFactory{name='a1', fieldName='S_SUPPKEY'}], outputColumns=[a0, a1], $hash=true}], timeColumnName=__time}, GroupByQuery{dataSource='supplier', dimensions=[DefaultDimensionSpec{dimension='S_SUPPKEY', outputName='d0'}], filter=S_COMMENT LIKE '%fluffily%requests%', aggregatorSpecs=[LiteralAggregatorFactory{value=true}], outputColumns=[d0, a0], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='P_BRAND', outputName='d0'}, DefaultDimensionSpec{dimension='P_TYPE', outputName='d1'}, DefaultDimensionSpec{dimension='P_SIZE', outputName='d2'}], filter=((a0=='0' || a00==NULL) && (a0=='0' || MathExprFilter{expression='(a1 >= a0)'}) && (a0=='0' || !(PS_SUPPKEY==NULL))), aggregatorSpecs=[CardinalityAggregatorFactory{name='_a0', fieldNames=[PS_SUPPKEY], groupingSets=Noop, byRow=true, round=true, b=11}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='_a0', direction=descending}, OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, _a0]}",
          ...
          "GroupByQuery{dataSource='supplier', dimensions=[DefaultDimensionSpec{dimension='S_SUPPKEY', outputName='d0'}], filter=S_COMMENT LIKE '%fluffily%requests%', aggregatorSpecs=[LiteralAggregatorFactory{value=true}], outputColumns=[d0, a0], $hash=true}"
      );
    } else {
      if (bloomFilter) {
        hook.verifyHooked(
            "FMPKM+ooLZpYbp62EMvHtg==",
            "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='partsupp', filter=BloomDimFilter.Factory{bloomSource=$view:part[P_PARTKEY]((!(P_BRAND=='Brand#34') && InDimFilter{dimension='P_SIZE', values=[14, 21, 22, 27, 28, 33, 35, 49]} && !(P_TYPE LIKE 'ECONOMY BRUSHED%'))), fields=[DefaultDimensionSpec{dimension='PS_PARTKEY', outputName='PS_PARTKEY'}], groupingSets=Noop, maxNumEntries=149}, columns=[PS_PARTKEY, PS_SUPPKEY]}, StreamQuery{dataSource='part', filter=(!(P_BRAND=='Brand#34') && InDimFilter{dimension='P_SIZE', values=[14, 21, 22, 27, 28, 33, 35, 49]} && !(P_TYPE LIKE 'ECONOMY BRUSHED%')), columns=[P_BRAND, P_PARTKEY, P_SIZE, P_TYPE], $hash=true}], timeColumnName=__time}, TimeseriesQuery{dataSource='supplier', filter=S_COMMENT LIKE '%fluffily%requests%', aggregatorSpecs=[CountAggregatorFactory{name='a0'}, CountAggregatorFactory{name='a1', fieldName='S_SUPPKEY'}], outputColumns=[a0, a1], $hash=true}], timeColumnName=__time}, GroupByQuery{dataSource='supplier', dimensions=[DefaultDimensionSpec{dimension='S_SUPPKEY', outputName='d0'}], filter=S_COMMENT LIKE '%fluffily%requests%', aggregatorSpecs=[LiteralAggregatorFactory{value=true}], outputColumns=[d0, a0], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='P_BRAND', outputName='d0'}, DefaultDimensionSpec{dimension='P_TYPE', outputName='d1'}, DefaultDimensionSpec{dimension='P_SIZE', outputName='d2'}], filter=((a0=='0' || a00==NULL) && (a0=='0' || MathExprFilter{expression='(a1 >= a0)'}) && (a0=='0' || !(PS_SUPPKEY==NULL))), aggregatorSpecs=[CardinalityAggregatorFactory{name='_a0', fieldNames=[PS_SUPPKEY], groupingSets=Noop, byRow=true, round=true, b=11}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='_a0', direction=descending}, OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, _a0]}",
        ...
        hook.verifyHooked(
            "ZVSdMsxxRm1DIW/qrhNwYQ==",
            "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='partsupp', columns=[PS_PARTKEY, PS_SUPPKEY]}, StreamQuery{dataSource='part', filter=(!(P_BRAND=='Brand#34') && InDimFilter{dimension='P_SIZE', values=[14, 21, 22, 27, 28, 33, 35, 49]} && !(P_TYPE LIKE 'ECONOMY BRUSHED%')), columns=[P_BRAND, P_PARTKEY, P_SIZE, P_TYPE], $hash=true}], timeColumnName=__time}, TimeseriesQuery{dataSource='supplier', filter=S_COMMENT LIKE '%fluffily%requests%', aggregatorSpecs=[CountAggregatorFactory{name='a0'}, CountAggregatorFactory{name='a1', fieldName='S_SUPPKEY'}], outputColumns=[a0, a1], $hash=true}], timeColumnName=__time}, GroupByQuery{dataSource='supplier', dimensions=[DefaultDimensionSpec{dimension='S_SUPPKEY', outputName='d0'}], filter=S_COMMENT LIKE '%fluffily%requests%', aggregatorSpecs=[LiteralAggregatorFactory{value=true}], outputColumns=[d0, a0], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='P_BRAND', outputName='d0'}, DefaultDimensionSpec{dimension='P_TYPE', outputName='d1'}, DefaultDimensionSpec{dimension='P_SIZE', outputName='d2'}], filter=((a0=='0' || a00==NULL) && (a0=='0' || MathExprFilter{expression='(a1 >= a0)'}) && (a0=='0' || !(PS_SUPPKEY==NULL))), aggregatorSpecs=[CardinalityAggregatorFactory{name='_a0', fieldNames=[PS_SUPPKEY], groupingSets=Noop, byRow=true, round=true, b=11}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='_a0', direction=descending}, OrderByColumnSpec{dimension='d0', direction=ascending}, OrderByColumnSpec{dimension='d1', direction=ascending}, OrderByColumnSpec{dimension='d2', direction=ascending}], limit=-1}, outputColumns=[d0, d1, d2, _a0]}",
    ...
    if (semiJoin) {
      if (broadcastJoin) {
        hook.verifyHooked(
            ...
            "TimeseriesQuery{dataSource='StreamQuery{dataSource='lineitem', filter=InDimFilter{dimension='L_PARTKEY', values=[558, 855]}, columns=[L_QUANTITY, L_PARTKEY, L_EXTENDEDPRICE], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem+part, leftJoinColumns=[d0], rightAlias=lineitem+part$, rightJoinColumns=[L_PARTKEY]}, hashLeft=true, hashSignature={d0:string, p0:double}, applyFilter=true}}', filter=MathExprFilter{expression='(L_QUANTITY < p0)'}, aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_EXTENDEDPRICE', inputType='double'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='(a0 / 7.0B)', finalize=true}], outputColumns=[p0]}",
            "StreamQuery{dataSource='lineitem', filter=InDimFilter{dimension='L_PARTKEY', values=[558, 855]}, columns=[L_QUANTITY, L_PARTKEY, L_EXTENDEDPRICE], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem+part, leftJoinColumns=[d0], rightAlias=lineitem+part$, rightJoinColumns=[L_PARTKEY]}, hashLeft=true, hashSignature={d0:string, p0:double}, applyFilter=true}}"
        );
      } else {
        hook.verifyHooked(
            "PWH1p1H/CX1yn8tZiYYPsg==",
            "GroupByQuery{dataSource='part', dimensions=[DefaultDimensionSpec{dimension='P_PARTKEY', outputName='d0'}], filter=(P_BRAND=='Brand#31' && P_CONTAINER=='MED BOX'), outputColumns=[d0]}",
      ...
      hook.verifyHooked(
          "TULa/jabpyI3EumslAkp/Q==",
          "GroupByQuery{dataSource='part', dimensions=[DefaultDimensionSpec{dimension='P_PARTKEY', outputName='d0'}], filter=(P_BRAND=='Brand#31' && P_CONTAINER=='MED BOX'), outputColumns=[d0]}",
          "GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', columns=[L_PARTKEY, L_QUANTITY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_PARTKEY], rightAlias=part, rightJoinColumns=[d0]}, hashLeft=false, hashSignature={d0:string}, applyFilter=true}}', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0:sum', fieldName='L_QUANTITY', inputType='long'}, CountAggregatorFactory{name='a0:count', fieldName='L_QUANTITY'}], postAggregatorSpecs=[ArithmeticPostAggregator{name='a0', fnName='quotient', fields=[FieldAccessPostAggregator{fieldName='a0:sum'}, FieldAccessPostAggregator{fieldName='a0:count'}], op=QUOTIENT}, MathPostAggregator{name='p0', expression='(0.2B * a0)', finalize=true}], outputColumns=[d0, p0]}",
          "StreamQuery{dataSource='lineitem', columns=[L_PARTKEY, L_QUANTITY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_PARTKEY], rightAlias=part, rightJoinColumns=[d0]}, hashLeft=false, hashSignature={d0:string}, applyFilter=true}}",
          "TimeseriesQuery{dataSource='StreamQuery{dataSource='lineitem', columns=[L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_PARTKEY], rightAlias=part, rightJoinColumns=[d0]}, hashLeft=false, hashSignature={d0:string}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem+part, leftJoinColumns=[d0], rightAlias=lineitem+part$, rightJoinColumns=[L_PARTKEY]}, hashLeft=true, hashSignature={d0:string, p0:double}, applyFilter=true}]}', filter=MathExprFilter{expression='(L_QUANTITY < p0)'}, aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_EXTENDEDPRICE', inputType='double'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='(a0 / 7.0B)', finalize=true}], outputColumns=[p0]}",
          "StreamQuery{dataSource='lineitem', columns=[L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_PARTKEY], rightAlias=part, rightJoinColumns=[d0]}, hashLeft=false, hashSignature={d0:string}, applyFilter=true}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem+part, leftJoinColumns=[d0], rightAlias=lineitem+part$, rightJoinColumns=[L_PARTKEY]}, hashLeft=true, hashSignature={d0:string, p0:double}, applyFilter=true}]}"
      );
    } else {
      hook.verifyHooked(
    ...
    if (semiJoin) {
      if (broadcastJoin) {
        hook.verifyHooked(
            ...
            "StreamQuery{dataSource='lineitem', filter=!(L_PARTKEY==NULL), columns=[L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_PARTKEY], rightAlias=part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_PARTKEY:string}, applyFilter=true}, $hash=true}",
      ...
      if (broadcastJoin) {
        hook.verifyHooked(
            "p2PUUT2QbHU7irxutNM8oA==",
            "StreamQuery{dataSource='part', filter=(P_BRAND=='Brand#31' && P_CONTAINER=='MED BOX' && !(P_PARTKEY==NULL)), columns=[P_PARTKEY]}",
            "DimensionSamplingQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}], filter=!(L_PARTKEY==NULL), sampleRatio=0.050}",
            "TimeseriesQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_PARTKEY==NULL), columns=[L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_PARTKEY], rightAlias=part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_PARTKEY:string}, applyFilter=true}, $hash=true}, GroupByQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}], filter=!(L_PARTKEY==NULL), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0:sum', fieldName='L_QUANTITY', inputType='long'}, CountAggregatorFactory{name='a0:count', fieldName='L_QUANTITY'}], postAggregatorSpecs=[ArithmeticPostAggregator{name='a0', fnName='quotient', fields=[FieldAccessPostAggregator{fieldName='a0:sum'}, FieldAccessPostAggregator{fieldName='a0:count'}], op=QUOTIENT}], outputColumns=[d0, a0]}], timeColumnName=__time}', filter=MathExprFilter{expression='(L_QUANTITY < (0.2B * a0))'}, aggregatorSpecs=[GenericSumAggregatorFactory{name='_a0', fieldName='L_EXTENDEDPRICE', inputType='double'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='(_a0 / 7.0B)', finalize=true}], outputColumns=[p0]}",
            "StreamQuery{dataSource='lineitem', filter=!(L_PARTKEY==NULL), columns=[L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_PARTKEY], rightAlias=part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_PARTKEY:string}, applyFilter=true}, $hash=true}",
            "GroupByQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}], filter=!(L_PARTKEY==NULL), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0:sum', fieldName='L_QUANTITY', inputType='long'}, CountAggregatorFactory{name='a0:count', fieldName='L_QUANTITY'}], postAggregatorSpecs=[ArithmeticPostAggregator{name='a0', fnName='quotient', fields=[FieldAccessPostAggregator{fieldName='a0:sum'}, FieldAccessPostAggregator{fieldName='a0:count'}], op=QUOTIENT}], outputColumns=[d0, a0]}"
        );
      } else {
  ...
  public static final String TPCH18_EXPLAIN_JR =
      "DruidOuterQueryRel(group=[{0, 1, 2, 3, 4}], EXPR$5=[SUM($5)], sort=[$4:DESC, $3:ASC, $2:ASC], fetch=[100])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[1], outputColumns=[6, 5, 3, 2, 4, 1])\n"
      + "    DruidQueryRel(table=[druid.lineitem], scanProject=[$6, $8])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[1, 2, 3, 4, 5])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[0], outputColumns=[0, 1, 2, 3])\n"
      + "        DruidQueryRel(table=[druid.orders], scanProject=[$2, $3, $4, $8])\n"
      + "        DruidQueryRel(table=[druid.lineitem], scanProject=[$6, $8], group=[{0}], agg#0=[SUM($1)], aggregateFilter=[>($1, 300)], aggregateProject=[$0])\n"
      + "      DruidQueryRel(table=[druid.customer], scanProject=[$3, $5])\n";
  ...
  public static final String TPCH19_EXPLAIN =
      "DruidOuterQueryRel(scanFilter=[OR(AND(=($2, 'Brand#32'), SEARCH($3, Sarg['SM BOX':VARCHAR(7), 'SM CASE':VARCHAR(7), 'SM PACK':VARCHAR(7), 'SM PKG':VARCHAR(7)]:VARCHAR(7)), SEARCH($4, Sarg[[7..17]]), SEARCH($5, Sarg[[1..5]])), AND(=($2, 'Brand#35'), SEARCH($3, Sarg['MED BAG':VARCHAR(8), 'MED BOX':VARCHAR(8), 'MED PACK':VARCHAR(8), 'MED PKG':VARCHAR(8)]:VARCHAR(8)), SEARCH($4, Sarg[[15..25]]), SEARCH($5, Sarg[[1..10]])), AND(=($2, 'Brand#24'), SEARCH($3, Sarg['LG BOX':VARCHAR(7), 'LG CASE':VARCHAR(7), 'LG PACK':VARCHAR(7), 'LG PKG':VARCHAR(7)]:VARCHAR(7)), SEARCH($4, Sarg[[26..36]]), SEARCH($5, Sarg[[1..15]])))], scanProject=[*($0, -(1, $1))], REVENUE=[SUM($0)])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[2], outputColumns=[1, 0, 4, 5, 3, 7])\n"
      + "    DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(SEARCH($13, Sarg['AIR':VARCHAR(7), 'AIR REG':VARCHAR(7)]:VARCHAR(7)), =($12, 'NONE'), IS NOT NULL($8))], scanProject=[$2, $3, $7, $8])\n"
      + "    DruidQueryRel(table=[druid.part], scanFilter=[AND(SEARCH($0, Sarg['Brand#24', 'Brand#32', 'Brand#35']:CHAR(8)), SEARCH($2, Sarg['LG BOX':VARCHAR(8), 'LG CASE':VARCHAR(8), 'LG PACK':VARCHAR(8), 'LG PKG':VARCHAR(8), 'MED BAG':VARCHAR(8), 'MED BOX':VARCHAR(8), 'MED PACK':VARCHAR(8), 'MED PKG':VARCHAR(8), 'SM BOX':VARCHAR(8), 'SM CASE':VARCHAR(8), 'SM PACK':VARCHAR(8), 'SM PKG':VARCHAR(8)]:VARCHAR(8)), SEARCH($7, Sarg[[1..15]]))], scanProject=[$0, $2, $5, $7])\n";
  ...
  public void tpch19() throws Exception
  {
    ...
    if (broadcastJoin) {
      hook.verifyHooked(
          "dR2gb7RCR1XxEw7zqilS7w==",
          "StreamQuery{dataSource='part', filter=(InDimFilter{dimension='P_BRAND', values=[Brand#24, Brand#32, Brand#35]} && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG, MED BAG, MED BOX, MED PACK, MED PKG, SM BOX, SM CASE, ..2 more]} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)}), columns=[P_BRAND, P_CONTAINER, P_PARTKEY, P_SIZE]}",
          "TimeseriesQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(InDimFilter{dimension='L_SHIPMODE', values=[AIR, AIR REG]} && L_SHIPINSTRUCT=='NONE' && !(L_QUANTITY==NULL)), columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_PARTKEY], rightAlias=part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_BRAND:string, P_CONTAINER:string, P_PARTKEY:string, P_SIZE:long}, applyFilter=true}}', filter=((P_BRAND=='Brand#32' && InDimFilter{dimension='P_CONTAINER', values=[SM BOX, SM CASE, SM PACK, SM PKG]} && BoundDimFilter{7 <= L_QUANTITY <= 17(numeric)} && BoundDimFilter{1 <= P_SIZE <= 5(numeric)}) || (P_BRAND=='Brand#35' && InDimFilter{dimension='P_CONTAINER', values=[MED BAG, MED BOX, MED PACK, MED PKG]} && BoundDimFilter{15 <= L_QUANTITY <= 25(numeric)} && BoundDimFilter{1 <= P_SIZE <= 10(numeric)}) || (P_BRAND=='Brand#24' && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG]} && BoundDimFilter{26 <= L_QUANTITY <= 36(numeric)} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)})), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], outputColumns=[a0]}",
          "StreamQuery{dataSource='lineitem', filter=(InDimFilter{dimension='L_SHIPMODE', values=[AIR, AIR REG]} && L_SHIPINSTRUCT=='NONE' && !(L_QUANTITY==NULL)), columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_PARTKEY], rightAlias=part, rightJoinColumns=[P_PARTKEY]}, hashLeft=false, hashSignature={P_BRAND:string, P_CONTAINER:string, P_PARTKEY:string, P_SIZE:long}, applyFilter=true}}"
      );
    } else if (semiJoin) {
      hook.verifyHooked(
          "tvV8CjNMbb3bmOQyuyESCQ==",
          "StreamQuery{dataSource='part', filter=(InDimFilter{dimension='P_BRAND', values=[Brand#24, Brand#32, Brand#35]} && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG, MED BAG, MED BOX, MED PACK, MED PKG, SM BOX, SM CASE, ..2 more]} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)}), columns=[P_BRAND, P_CONTAINER, P_PARTKEY, P_SIZE], $hash=true}",
          "TimeseriesQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(InDimFilter{dimension='L_SHIPMODE', values=[AIR, AIR REG]} && L_SHIPINSTRUCT=='NONE' && !(L_QUANTITY==NULL) && InDimFilter{dimension='L_PARTKEY', values=[124, 139, 149, 16, 208, 395, 408, 5, 6, 620, ..10 more]}), columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY]}, MaterializedQuery{dataSource=[part]}], timeColumnName=__time}', filter=((P_BRAND=='Brand#32' && InDimFilter{dimension='P_CONTAINER', values=[SM BOX, SM CASE, SM PACK, SM PKG]} && BoundDimFilter{7 <= L_QUANTITY <= 17(numeric)} && BoundDimFilter{1 <= P_SIZE <= 5(numeric)}) || (P_BRAND=='Brand#35' && InDimFilter{dimension='P_CONTAINER', values=[MED BAG, MED BOX, MED PACK, MED PKG]} && BoundDimFilter{15 <= L_QUANTITY <= 25(numeric)} && BoundDimFilter{1 <= P_SIZE <= 10(numeric)}) || (P_BRAND=='Brand#24' && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG]} && BoundDimFilter{26 <= L_QUANTITY <= 36(numeric)} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)})), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], outputColumns=[a0]}",
          "StreamQuery{dataSource='lineitem', filter=(InDimFilter{dimension='L_SHIPMODE', values=[AIR, AIR REG]} && L_SHIPINSTRUCT=='NONE' && !(L_QUANTITY==NULL) && InDimFilter{dimension='L_PARTKEY', values=[124, 139, 149, 16, 208, 395, 408, 5, 6, 620, ..10 more]}), columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY]}"
      );
    } else {
      if (bloomFilter) {
        hook.verifyHooked(
            "IIs5NFG/0j7s/WS/igaSTw==",
            "TimeseriesQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(InDimFilter{dimension='L_SHIPMODE', values=[AIR, AIR REG]} && L_SHIPINSTRUCT=='NONE' && !(L_QUANTITY==NULL) && BloomDimFilter.Factory{bloomSource=$view:part[P_PARTKEY]((InDimFilter{dimension='P_BRAND', values=[Brand#24, Brand#32, Brand#35]} && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG, MED BAG, MED BOX, MED PACK, MED PKG, SM BOX, SM CASE, ..2 more]} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)})), fields=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='L_PARTKEY'}], groupingSets=Noop, maxNumEntries=20}), columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY]}, StreamQuery{dataSource='part', filter=(InDimFilter{dimension='P_BRAND', values=[Brand#24, Brand#32, Brand#35]} && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG, MED BAG, MED BOX, MED PACK, MED PKG, SM BOX, SM CASE, ..2 more]} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)}), columns=[P_BRAND, P_CONTAINER, P_PARTKEY, P_SIZE], $hash=true}], timeColumnName=__time}', filter=((P_BRAND=='Brand#32' && InDimFilter{dimension='P_CONTAINER', values=[SM BOX, SM CASE, SM PACK, SM PKG]} && BoundDimFilter{7 <= L_QUANTITY <= 17(numeric)} && BoundDimFilter{1 <= P_SIZE <= 5(numeric)}) || (P_BRAND=='Brand#35' && InDimFilter{dimension='P_CONTAINER', values=[MED BAG, MED BOX, MED PACK, MED PKG]} && BoundDimFilter{15 <= L_QUANTITY <= 25(numeric)} && BoundDimFilter{1 <= P_SIZE <= 10(numeric)}) || (P_BRAND=='Brand#24' && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG]} && BoundDimFilter{26 <= L_QUANTITY <= 36(numeric)} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)})), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], outputColumns=[a0]}",
            "TimeseriesQuery{dataSource='part', filter=(InDimFilter{dimension='P_BRAND', values=[Brand#24, Brand#32, Brand#35]} && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG, MED BAG, MED BOX, MED PACK, MED PKG, SM BOX, SM CASE, ..2 more]} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)}), aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[P_PARTKEY], groupingSets=Noop, byRow=true, maxNumEntries=20}]}",
            "StreamQuery{dataSource='lineitem', filter=(InDimFilter{dimension='L_SHIPMODE', values=[AIR, AIR REG]} && L_SHIPINSTRUCT=='NONE' && !(L_QUANTITY==NULL) && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='L_PARTKEY'}], groupingSets=Noop}), columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY]}",
            "StreamQuery{dataSource='part', filter=(InDimFilter{dimension='P_BRAND', values=[Brand#24, Brand#32, Brand#35]} && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG, MED BAG, MED BOX, MED PACK, MED PKG, SM BOX, SM CASE, ..2 more]} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)}), columns=[P_BRAND, P_CONTAINER, P_PARTKEY, P_SIZE], $hash=true}"
        );
      } else {
        hook.verifyHooked(
            "ry39iAW90uX+UBNCVlGoQQ==",
            "TimeseriesQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(InDimFilter{dimension='L_SHIPMODE', values=[AIR, AIR REG]} && L_SHIPINSTRUCT=='NONE' && !(L_QUANTITY==NULL)), columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY]}, StreamQuery{dataSource='part', filter=(InDimFilter{dimension='P_BRAND', values=[Brand#24, Brand#32, Brand#35]} && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG, MED BAG, MED BOX, MED PACK, MED PKG, SM BOX, SM CASE, ..2 more]} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)}), columns=[P_BRAND, P_CONTAINER, P_PARTKEY, P_SIZE], $hash=true}], timeColumnName=__time}', filter=((P_BRAND=='Brand#32' && InDimFilter{dimension='P_CONTAINER', values=[SM BOX, SM CASE, SM PACK, SM PKG]} && BoundDimFilter{7 <= L_QUANTITY <= 17(numeric)} && BoundDimFilter{1 <= P_SIZE <= 5(numeric)}) || (P_BRAND=='Brand#35' && InDimFilter{dimension='P_CONTAINER', values=[MED BAG, MED BOX, MED PACK, MED PKG]} && BoundDimFilter{15 <= L_QUANTITY <= 25(numeric)} && BoundDimFilter{1 <= P_SIZE <= 10(numeric)}) || (P_BRAND=='Brand#24' && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG]} && BoundDimFilter{26 <= L_QUANTITY <= 36(numeric)} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)})), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldExpression='(L_EXTENDEDPRICE * (1 - L_DISCOUNT))', inputType='double'}], outputColumns=[a0]}",
            "StreamQuery{dataSource='lineitem', filter=(InDimFilter{dimension='L_SHIPMODE', values=[AIR, AIR REG]} && L_SHIPINSTRUCT=='NONE' && !(L_QUANTITY==NULL)), columns=[L_DISCOUNT, L_EXTENDEDPRICE, L_PARTKEY, L_QUANTITY]}",
            "StreamQuery{dataSource='part', filter=(InDimFilter{dimension='P_BRAND', values=[Brand#24, Brand#32, Brand#35]} && InDimFilter{dimension='P_CONTAINER', values=[LG BOX, LG CASE, LG PACK, LG PKG, MED BAG, MED BOX, MED PACK, MED PKG, SM BOX, SM CASE, ..2 more]} && BoundDimFilter{1 <= P_SIZE <= 15(numeric)}), columns=[P_BRAND, P_CONTAINER, P_PARTKEY, P_SIZE], $hash=true}"
        );
      }
    }
  ...
  public static final String TPCH20_EXPLAIN =
      ...
      + "        DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(SEARCH($11, Sarg[['1994-01-01'..'1995-01-01')]:CHAR(10)), IS NOT NULL($7), IS NOT NULL($14))], scanProject=[$7, $14, $8], group=[{0, 1}], agg#0=[SUM($2)])\n";

  public static final String TPCH20_EXPLAIN_JR =
      "DruidOuterQueryRel(sort=[$0:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[0], outputColumns=[1, 0])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[0], outputColumns=[0, 1, 3])\n"
      + "      DruidQueryRel(table=[druid.supplier], scanFilter=[IS NOT NULL($6)], scanProject=[$1, $3, $4, $6])\n"
      + "      DruidQueryRel(table=[druid.nation], scanFilter=[=($1, 'RUSSIA')], scanProject=[$2])\n"
      + "    DruidOuterQueryRel(scanFilter=[>($1, *(0.5:DECIMAL(2, 1), $2))], scanProject=[$0], group=[{0}])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[0, 1], rightKeys=[1, 2], outputColumns=[5, 3, 2])\n"
      + "        DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(SEARCH($11, Sarg[['1994-01-01'..'1995-01-01')]:CHAR(10)), IS NOT NULL($7), IS NOT NULL($14))], scanProject=[$7, $14, $8], group=[{0, 1}], agg#0=[SUM($2)])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[0], outputColumns=[0, 1, 2])\n"
      + "          DruidQueryRel(table=[druid.partsupp], scanFilter=[AND(IS NOT NULL($2), IS NOT NULL($3))], scanProject=[$0, $2, $3])\n"
      + "          DruidQueryRel(table=[druid.part], scanFilter=[AND(LIKE($4, 'forest%'), IS NOT NULL($5))], scanProject=[$5], group=[{0}])\n";
  ...
  public static final String TPCH20_EXPLAIN_JR2 =
      ...
      + "          DruidJoinRel(joinType=[INNER], leftKeys=[1, 2], rightKeys=[0, 1], outputColumns=[1, 2, 0, 5])\n"
      + "            DruidQueryRel(table=[druid.partsupp], scanFilter=[AND(IS NOT NULL($2), IS NOT NULL($3))], scanProject=[$0, $2, $3])\n"
      + "            DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(SEARCH($11, Sarg[['1994-01-01'..'1995-01-01')]:CHAR(10)), IS NOT NULL($7), IS NOT NULL($14))], scanProject=[$7, $14, $8], group=[{0, 1}], agg#0=[SUM($2)])\n"
      + "        DruidQueryRel(table=[druid.part], scanFilter=[AND(LIKE($4, 'forest%'), IS NOT NULL($5))], scanProject=[$5], group=[{0}])\n";
  ...
  public void tpch20() throws Exception
  {
    ...
    if (semiJoin) {
      hook.verifyHooked(
          ...
          "DimensionSamplingQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE < 1995-01-01} && !(L_PARTKEY==NULL) && !(L_SUPPKEY==NULL)), sampleRatio=0.050}",
          ...
          "GroupByQuery{dataSource='CommonJoin{queries=[MaterializedQuery{dataSource=[partsupp]}, GroupByQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE < 1995-01-01} && !(L_PARTKEY==NULL) && !(L_SUPPKEY==NULL) && InDimsFilter{dimensions=[L_PARTKEY, L_SUPPKEY], values=[[304, 23], [304, 41], [304, 5], [304, 9], [447, 18], [447, 38], [447, 48], [447, 8], [488, 10], [488, 2], [..20 more]]}), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_QUANTITY', inputType='long'}], outputColumns=[d0, d1, a0]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='PS_SUPPKEY', outputName='d0'}], filter=MathExprFilter{expression='(PS_AVAILQTY > (0.5B * a0))'}, outputColumns=[d0]}",
      ...
      if (broadcastJoin) {
        hook.verifyHooked(
            "5T0GcqeNmf1kPHN1HbeqJA==",
            "StreamQuery{dataSource='nation', filter=N_NAME=='RUSSIA', columns=[N_NATIONKEY]}",
            "GroupByQuery{dataSource='part', dimensions=[DefaultDimensionSpec{dimension='P_PARTKEY', outputName='d0'}], filter=(P_NAME LIKE 'forest%' && !(P_PARTKEY==NULL)), outputColumns=[d0]}",
            "DimensionSamplingQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE < 1995-01-01} && !(L_PARTKEY==NULL) && !(L_SUPPKEY==NULL)), sampleRatio=0.050}",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_ADDRESS, S_NAME, S_NATIONKEY, S_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}, applyFilter=true}, $hash=true}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='partsupp', filter=(!(PS_PARTKEY==NULL) && !(PS_SUPPKEY==NULL)), columns=[PS_AVAILQTY, PS_PARTKEY, PS_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_PARTKEY], rightAlias=part, rightJoinColumns=[d0]}, hashLeft=false, hashSignature={d0:string}, applyFilter=true}, $hash=true}, GroupByQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE < 1995-01-01} && !(L_PARTKEY==NULL) && !(L_SUPPKEY==NULL)), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_QUANTITY', inputType='long'}], outputColumns=[d0, d1, a0]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='PS_SUPPKEY', outputName='d0'}], filter=MathExprFilter{expression='(PS_AVAILQTY > (0.5B * a0))'}, outputColumns=[d0]}], timeColumnName=__time}', columns=[S_NAME, S_ADDRESS], orderingSpecs=[OrderByColumnSpec{dimension='S_NAME', direction=ascending}]}",
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='partsupp', filter=(!(PS_PARTKEY==NULL) && !(PS_SUPPKEY==NULL)), columns=[PS_AVAILQTY, PS_PARTKEY, PS_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_PARTKEY], rightAlias=part, rightJoinColumns=[d0]}, hashLeft=false, hashSignature={d0:string}, applyFilter=true}, $hash=true}, GroupByQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE < 1995-01-01} && !(L_PARTKEY==NULL) && !(L_SUPPKEY==NULL)), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_QUANTITY', inputType='long'}], outputColumns=[d0, d1, a0]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='PS_SUPPKEY', outputName='d0'}], filter=MathExprFilter{expression='(PS_AVAILQTY > (0.5B * a0))'}, outputColumns=[d0]}",
            "StreamQuery{dataSource='partsupp', filter=(!(PS_PARTKEY==NULL) && !(PS_SUPPKEY==NULL)), columns=[PS_AVAILQTY, PS_PARTKEY, PS_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_PARTKEY], rightAlias=part, rightJoinColumns=[d0]}, hashLeft=false, hashSignature={d0:string}, applyFilter=true}, $hash=true}",
            "GroupByQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE < 1995-01-01} && !(L_PARTKEY==NULL) && !(L_SUPPKEY==NULL)), aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_QUANTITY', inputType='long'}], outputColumns=[d0, d1, a0]}",
            "StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_ADDRESS, S_NAME, S_NATIONKEY, S_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}, applyFilter=true}, $hash=true}"
        );
      } else {
        hook.verifyHooked(
            "AQolzcuDq/+4RZxWYDCpBg==",
            "DimensionSamplingQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE < 1995-01-01} && !(L_PARTKEY==NULL) && !(L_SUPPKEY==NULL)), sampleRatio=0.050}",
  ...
  public static final String TPCH20_2_EXPLAIN =
      ...
      + "            DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(SEARCH($11, Sarg[['1994-01-01'..'1995-01-01']]:CHAR(10)), IS NOT NULL($7))], scanProject=[$7, $8, $14])\n"
      + "            DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[1])\n"
      + "              DruidQueryRel(table=[druid.supplier], scanProject=[$4, $6])\n"
      + "              DruidQueryRel(table=[druid.nation], scanFilter=[=($1, 'RUSSIA')], scanProject=[$2])\n";
  ...
  public void tpch20_2() throws Exception
  {
    ...
    if (semiJoin) {
      hook.verifyHooked(
          ...
          "GroupByQuery{dataSource='CommonJoin{queries=[MaterializedQuery{dataSource=[partsupp]}, GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE <= 1995-01-01} && !(L_PARTKEY==NULL) && InDimFilter{dimension='L_SUPPKEY', values=[16, 25, 40, 42]}), columns=[L_PARTKEY, L_SUPPKEY, L_QUANTITY]}', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], filter=InDimsFilter{dimensions=[L_PARTKEY, L_SUPPKEY], values=[[304, 23], [304, 41], [304, 5], [304, 9], [447, 18], [447, 38], [447, 48], [447, 8], [488, 10], [488, 2], [..20 more]]}, aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_QUANTITY', inputType='long'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='(0.5B * a0)', finalize=true}], outputColumns=[d0, p0, d1]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='PS_SUPPKEY', outputName='d0'}], filter=MathExprFilter{expression='(PS_AVAILQTY > p0)'}, outputColumns=[d0]}",
          "GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE <= 1995-01-01} && !(L_PARTKEY==NULL) && InDimFilter{dimension='L_SUPPKEY', values=[16, 25, 40, 42]}), columns=[L_PARTKEY, L_SUPPKEY, L_QUANTITY]}', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], filter=InDimsFilter{dimensions=[L_PARTKEY, L_SUPPKEY], values=[[304, 23], [304, 41], [304, 5], [304, 9], [447, 18], [447, 38], [447, 48], [447, 8], [488, 10], [488, 2], [..20 more]]}, aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_QUANTITY', inputType='long'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='(0.5B * a0)', finalize=true}], outputColumns=[d0, p0, d1]}",
          "StreamQuery{dataSource='lineitem', filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE <= 1995-01-01} && !(L_PARTKEY==NULL) && InDimFilter{dimension='L_SUPPKEY', values=[16, 25, 40, 42]}), columns=[L_PARTKEY, L_SUPPKEY, L_QUANTITY]}",
      ...
      if (broadcastJoin) {
        hook.verifyHooked(
            "xaiTc9jKSKXs24mAx/HCwQ==",
            "GroupByQuery{dataSource='part', dimensions=[DefaultDimensionSpec{dimension='P_PARTKEY', outputName='d0'}], filter=P_NAME LIKE 'forest%', outputColumns=[d0]}",
            "StreamQuery{dataSource='nation', filter=N_NAME=='RUSSIA', columns=[N_NATIONKEY]}",
            "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}, applyFilter=true}}",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_ADDRESS, S_NAME, S_SUPPKEY], $hash=true}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='partsupp', filter=!(PS_SUPPKEY==NULL), columns=[PS_AVAILQTY, PS_PARTKEY, PS_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_PARTKEY], rightAlias=part, rightJoinColumns=[d0]}, hashLeft=false, hashSignature={d0:string}, applyFilter=true}, $hash=true}, GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE <= 1995-01-01} && !(L_PARTKEY==NULL)), columns=[L_PARTKEY, L_QUANTITY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_SUPPKEY], rightAlias=supplier+nation, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_SUPPKEY:string}, applyFilter=true}}', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_QUANTITY', inputType='long'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='(0.5B * a0)', finalize=true}], outputColumns=[d0, p0, d1]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='PS_SUPPKEY', outputName='d0'}], filter=MathExprFilter{expression='(PS_AVAILQTY > p0)'}, outputColumns=[d0]}], timeColumnName=__time}', columns=[S_NAME, S_ADDRESS], orderingSpecs=[OrderByColumnSpec{dimension='S_NAME', direction=ascending}]}",
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='partsupp', filter=!(PS_SUPPKEY==NULL), columns=[PS_AVAILQTY, PS_PARTKEY, PS_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_PARTKEY], rightAlias=part, rightJoinColumns=[d0]}, hashLeft=false, hashSignature={d0:string}, applyFilter=true}, $hash=true}, GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE <= 1995-01-01} && !(L_PARTKEY==NULL)), columns=[L_PARTKEY, L_QUANTITY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_SUPPKEY], rightAlias=supplier+nation, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_SUPPKEY:string}, applyFilter=true}}', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_QUANTITY', inputType='long'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='(0.5B * a0)', finalize=true}], outputColumns=[d0, p0, d1]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='PS_SUPPKEY', outputName='d0'}], filter=MathExprFilter{expression='(PS_AVAILQTY > p0)'}, outputColumns=[d0]}",
            "GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE <= 1995-01-01} && !(L_PARTKEY==NULL)), columns=[L_PARTKEY, L_QUANTITY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_SUPPKEY], rightAlias=supplier+nation, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_SUPPKEY:string}, applyFilter=true}}', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_QUANTITY', inputType='long'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='(0.5B * a0)', finalize=true}], outputColumns=[d0, p0, d1]}",
            "StreamQuery{dataSource='lineitem', filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE <= 1995-01-01} && !(L_PARTKEY==NULL)), columns=[L_PARTKEY, L_QUANTITY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=lineitem, leftJoinColumns=[L_SUPPKEY], rightAlias=supplier+nation, rightJoinColumns=[S_SUPPKEY]}, hashLeft=false, hashSignature={S_SUPPKEY:string}, applyFilter=true}}",
            "StreamQuery{dataSource='partsupp', filter=!(PS_SUPPKEY==NULL), columns=[PS_AVAILQTY, PS_PARTKEY, PS_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=partsupp, leftJoinColumns=[PS_PARTKEY], rightAlias=part, rightJoinColumns=[d0]}, hashLeft=false, hashSignature={d0:string}, applyFilter=true}, $hash=true}",
            "StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_ADDRESS, S_NAME, S_SUPPKEY], $hash=true}"
        );
      } else {
        hook.verifyHooked(
            "lUeB9xdnUresv/fomKTnLA==",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_ADDRESS, S_NAME, S_SUPPKEY], $hash=true}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='partsupp', filter=!(PS_SUPPKEY==NULL), columns=[PS_AVAILQTY, PS_PARTKEY, PS_SUPPKEY]}, GroupByQuery{dataSource='part', dimensions=[DefaultDimensionSpec{dimension='P_PARTKEY', outputName='d0'}], filter=P_NAME LIKE 'forest%', outputColumns=[d0], $hash=true}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE <= 1995-01-01} && !(L_PARTKEY==NULL)), columns=[L_PARTKEY, L_QUANTITY, L_SUPPKEY]}, CommonJoin{queries=[StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY]}, StreamQuery{dataSource='nation', filter=N_NAME=='RUSSIA', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_QUANTITY', inputType='long'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='(0.5B * a0)', finalize=true}], outputColumns=[d0, p0, d1]}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='PS_SUPPKEY', outputName='d0'}], filter=MathExprFilter{expression='(PS_AVAILQTY > p0)'}, outputColumns=[d0]}], timeColumnName=__time}', columns=[S_NAME, S_ADDRESS], orderingSpecs=[OrderByColumnSpec{dimension='S_NAME', direction=ascending}]}",
            ...
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE <= 1995-01-01} && !(L_PARTKEY==NULL)), columns=[L_PARTKEY, L_QUANTITY, L_SUPPKEY]}, CommonJoin{queries=[StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY]}, StreamQuery{dataSource='nation', filter=N_NAME=='RUSSIA', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_PARTKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], aggregatorSpecs=[GenericSumAggregatorFactory{name='a0', fieldName='L_QUANTITY', inputType='long'}], postAggregatorSpecs=[MathPostAggregator{name='p0', expression='(0.5B * a0)', finalize=true}], outputColumns=[d0, p0, d1]}",
            "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY]}",
            "StreamQuery{dataSource='nation', filter=N_NAME=='RUSSIA', columns=[N_NATIONKEY], $hash=true}",
            "StreamQuery{dataSource='lineitem', filter=(BoundDimFilter{1994-01-01 <= L_SHIPDATE <= 1995-01-01} && !(L_PARTKEY==NULL)), columns=[L_PARTKEY, L_QUANTITY, L_SUPPKEY]}",
            "StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_ADDRESS, S_NAME, S_SUPPKEY], $hash=true}"
        );
      }
    }
  ...
  public static final String TPCH21_EXPLAIN_JR =
      ...
      + "        DruidQueryRel(table=[druid.supplier], scanProject=[$3, $4, $6])\n"
      + "        DruidQueryRel(table=[druid.nation], scanFilter=[=($1, 'UNITED STATES')], scanProject=[$2])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[2, 1])\n"
      + "        DruidQueryRel(table=[druid.lineitem], scanProject=[$6, $14], group=[{0}], CNTSUPP=[COUNT(DISTINCT $1)], aggregateFilter=[>($1, 1)], aggregateProject=[$0])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[0, 1])\n"
      + "          DruidQueryRel(table=[druid.lineitem], scanFilter=[>($9, $1)], scanProject=[$6, $14])\n"
      + "          DruidQueryRel(table=[druid.orders], scanFilter=[=($6, 'F')], scanProject=[$4])\n";
      ...
      if (broadcastJoin) {
        if (bloomFilter) {
          hook.verifyHooked(
              ...
              "GroupByQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}], filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), aggregatorSpecs=[CardinalityAggregatorFactory{name='a0:a', fieldNames=[L_SUPPKEY], groupingSets=Noop, byRow=true, round=true, b=11}], postAggregatorSpecs=[HyperUniqueFinalizingPostAggregator{name='a0', fieldName='a0:a', round='true'}], havingSpec=ExpressionHavingSpec{expression='(a0 == 1)'}, outputColumns=[d0], $hash=true}",
              "StreamQuery{dataSource='supplier', columns=[S_NAME, S_NATIONKEY, S_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}, applyFilter=true}, $hash=true}"
          );
        } else {
          hook.verifyHooked(
              "mPzM6qcybAA1JBozL0+7Lg==",
              "DimensionSamplingQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}], sampleRatio=0.050}",
              "DimensionSamplingQuery{dataSource='lineitem', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}], filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), sampleRatio=0.050}",
              "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY]}",
  ...
  public static final String TPCH21_2 =
      "SELECT "
      + " S_NAME, "
      + " COUNT(*) AS NUMWAIT "
      + "FROM "
  ...
  public static final String TPCH21_2_EXPLAIN =
      "DruidOuterQueryRel(scanFilter=[IS NULL($1)], scanProject=[$0], group=[{0}], NUMWAIT=[COUNT()], sort=[$1:DESC, $0:ASC], fetch=[100])\n"
      + "  DruidJoinRel(joinType=[LEFT], leftKeys=[1, 2], rightKeys=[0, 1], outputColumns=[0, 5])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[4, 6], rightKeys=[0, 1], outputColumns=[0, 4, 6])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[4], rightKeys=[0], outputColumns=[0, 1, 2, 3, 4, 5, 6, 9, 10, 7, 8])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[3], outputColumns=[0, 1, 2, 5, 6, 7, 8, 3, 4])\n"
      + "          DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[1])\n"
      + "            DruidQueryRel(table=[druid.supplier], scanFilter=[IS NOT NULL($6)], scanProject=[$3, $4, $6])\n"
      + "            DruidQueryRel(table=[druid.nation], scanFilter=[=($1, 'UNITED STATES')], scanProject=[$1, $2])\n"
      + "          DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(>($9, $1), IS NOT NULL($14), IS NOT NULL($6))], scanProject=[$1, $6, $9, $14])\n"
      + "        DruidQueryRel(table=[druid.orders], scanFilter=[AND(=($6, 'F'), IS NOT NULL($4))], scanProject=[$4, $6])\n"
      + "      DruidOuterQueryRel(scanFilter=[<>($2, $1)], scanProject=[$0, $1], group=[{0, 1}])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[2, 3, 1])\n"
      + "          DruidQueryRel(table=[druid.lineitem], scanFilter=[IS NOT NULL($6)], scanProject=[$6, $14])\n"
      + "          DruidOuterQueryRel(group=[{0, 1}])\n"
      + "            DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[1, 2])\n"
      + "              DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[0], outputColumns=[0, 1, 2])\n"
      + "                DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[1], outputColumns=[0, 2, 3])\n"
      + "                  DruidQueryRel(table=[druid.supplier], scanProject=[$4, $6])\n"
      ...
      + "                DruidQueryRel(table=[druid.orders], scanFilter=[=($6, 'F')], scanProject=[$4])\n"
      + "              DruidQueryRel(table=[druid.nation], scanFilter=[=($1, 'UNITED STATES')], scanProject=[$2])\n"
      + "    DruidOuterQueryRel(scanFilter=[<>($2, $1)], scanProject=[$0, $1], group=[{0, 1}], aggregateProject=[$0, $1, true])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[2, 3, 1])\n"
      + "        DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(>($9, $1), IS NOT NULL($6))], scanProject=[$6, $14])\n"
      + "        DruidOuterQueryRel(group=[{0, 1}])\n"
      + "          DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[1, 2])\n"
      + "            DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[0], outputColumns=[0, 1, 2])\n"
      + "              DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[1], outputColumns=[0, 2, 3])\n"
  ...
  public static final String TPCH21_2_EXPLAIN_JR =
      "DruidOuterQueryRel(scanFilter=[IS NULL($1)], scanProject=[$0], group=[{0}], NUMWAIT=[COUNT()], sort=[$1:DESC, $0:ASC], fetch=[100])\n"
      + "  DruidJoinRel(joinType=[LEFT], leftKeys=[0, 1], rightKeys=[0, 1], outputColumns=[2, 5])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[2], outputColumns=[0, 1, 2])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[0, 1])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[1, 3], rightKeys=[0, 1], outputColumns=[1, 3])\n"
      + "          DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(>($9, $1), IS NOT NULL($14), IS NOT NULL($6))], scanProject=[$1, $6, $9, $14])\n"
      + "          DruidOuterQueryRel(scanFilter=[<>($2, $1)], scanProject=[$0, $1], group=[{0, 1}])\n"
      + "            DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[2, 3, 1])\n"
      + "              DruidQueryRel(table=[druid.lineitem], scanFilter=[IS NOT NULL($6)], scanProject=[$6, $14])\n"
  ...
  public static final String TPCH21_2_EXPLAIN_JR2 =
      "DruidOuterQueryRel(scanFilter=[IS NULL($1)], scanProject=[$0], group=[{0}], NUMWAIT=[COUNT()], sort=[$1:DESC, $0:ASC], fetch=[100])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[3, 4])\n"
      + "    DruidQueryRel(table=[druid.orders], scanFilter=[AND(=($6, 'F'), IS NOT NULL($4))], scanProject=[$4, $6])\n"
      + "    DruidJoinRel(joinType=[LEFT], leftKeys=[0, 1], rightKeys=[0, 1], outputColumns=[0, 2, 5])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[2], outputColumns=[0, 1, 2])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[1, 3], rightKeys=[0, 1], outputColumns=[1, 3])\n"
      + "          DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(>($9, $1), IS NOT NULL($14), IS NOT NULL($6))], scanProject=[$1, $6, $9, $14])\n"
      + "          DruidOuterQueryRel(scanFilter=[<>($2, $1)], scanProject=[$0, $1], group=[{0, 1}])\n"
  ...
  @Test
  public void tpch21_2() throws Exception
  {
    testQuery(TPCH21_2, TPCH21_2_EXPLAIN, TPCH21_RESULT);

    if (semiJoin) {
      if (broadcastJoin) {
        hook.verifyHooked(
            "xDweVsARbX1btw9miaCWvg==",
            "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY]}",
            "StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY]}",
            "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY]}",
            ...
            "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+nation, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NAME:string, S_NATIONKEY:string, S_SUPPKEY:string, N_NAME:string, N_NATIONKEY:string}, applyFilter=true}, $hash=true}",
            "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[MaterializedQuery{dataSource=[lineitem]}, StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL) && InDimFilter{dimension='O_ORDERKEY', values=[10019, 10052, 10080, 10117, 10144, 10150, 10211, 10242, 10244, 10272, ..1368 more]}), columns=[O_ORDERKEY, O_ORDERSTATUS]}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+lineitem+orders, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}}]}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1], $hash=true}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+lineitem+orders, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}}]}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='S_NAME', outputName='d0'}], filter=p0==NULL, aggregatorSpecs=[CountAggregatorFactory{name='a0'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='a0', direction=descending}, OrderByColumnSpec{dimension='d0', direction=ascending}], limit=100}, outputColumns=[d0, a0]}",
            "StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL) && InDimFilter{dimension='O_ORDERKEY', values=[10019, 10052, 10080, 10117, 10144, 10150, 10211, 10242, 10244, 10272, ..1368 more]}), columns=[O_ORDERKEY, O_ORDERSTATUS]}",
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+lineitem+orders, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}}]}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1], $hash=true}",
            "GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+lineitem+orders, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}}]}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
            "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+lineitem+orders, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}}]}",
            "StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}",
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+lineitem+orders, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}}]}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}",
            "GroupByQuery{dataSource='StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+lineitem+orders, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}}]}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
            "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=ListPostProcessingOperator[BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}, BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+lineitem+orders, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NATIONKEY:string}}]}",
            "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}"
        );
      } else {
        hook.verifyHooked(
            "PraNfO7q8ynGNHp7x0YXAw==",
            "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}",
            "StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY]}",
            "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NAME, N_NATIONKEY], $hash=true}",
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[MaterializedQuery{dataSource=[supplier]}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1]}",
            "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[MaterializedQuery{dataSource=[supplier]}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
            "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY]}",
            "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}",
            "StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}",
            "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=(!(S_SUPPKEY==NULL) && S_NATIONKEY=='24'), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY]}, MaterializedQuery{dataSource=[nation]}], timeColumnName=__time}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL) && InDimsFilter{dimensions=[L_ORDERKEY, L_SUPPKEY], values=[[10019, 46], [10052, 19], [10080, 46], [10117, 49], [10144, 10], [10144, 46], [10150, 10], [10242, 49], [10272, 19], [10438, 46], [..661 more]]}), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERSTATUS]}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[MaterializedQuery{dataSource=[supplier]}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='S_NAME', outputName='d0'}], filter=p0==NULL, aggregatorSpecs=[CountAggregatorFactory{name='a0'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='a0', direction=descending}, OrderByColumnSpec{dimension='d0', direction=ascending}], limit=100}, outputColumns=[d0, a0]}",
            "StreamQuery{dataSource='supplier', filter=(!(S_SUPPKEY==NULL) && S_NATIONKEY=='24'), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY]}",
            "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL) && InDimsFilter{dimensions=[L_ORDERKEY, L_SUPPKEY], values=[[10019, 46], [10052, 19], [10080, 46], [10117, 49], [10144, 10], [10144, 46], [10150, 10], [10242, 49], [10272, 19], [10438, 46], [..661 more]]}), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY]}",
            "StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERSTATUS]}",
            "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[MaterializedQuery{dataSource=[supplier]}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}",
            "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[MaterializedQuery{dataSource=[supplier]}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
            "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY]}",
            "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}",
            "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}"
      ...
      if (broadcastJoin) {
        if (bloomFilter) {
          hook.verifyHooked(
              "pEo2wcBhcGY5eJze167MsA==",
              "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY]}",
              "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NAME, N_NATIONKEY]}",
              "StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NAME:string, N_NATIONKEY:string}, applyFilter=true}}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+nation, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NAME:string, S_NATIONKEY:string, S_SUPPKEY:string, N_NAME:string, N_NATIONKEY:string}, applyFilter=true}}, StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL) && BloomDimFilter.Factory{bloomSource=$view:lineitem[L_ORDERKEY]((MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL))), fields=[DefaultDimensionSpec{dimension='O_ORDERKEY', outputName='O_ORDERKEY'}], groupingSets=Noop, maxNumEntries=2416}), columns=[O_ORDERKEY, O_ORDERSTATUS], $hash=true}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomDimFilter.Factory{bloomSource=$view:orders[O_ORDERKEY](O_ORDERSTATUS=='F'), fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop, maxNumEntries=3655}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1], $hash=true}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomDimFilter.Factory{bloomSource=$view:orders[O_ORDERKEY](O_ORDERSTATUS=='F'), fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop, maxNumEntries=3655}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='S_NAME', outputName='d0'}], filter=p0==NULL, aggregatorSpecs=[CountAggregatorFactory{name='a0'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='a0', direction=descending}, OrderByColumnSpec{dimension='d0', direction=ascending}], limit=100}, outputColumns=[d0, a0]}",
              "TimeseriesQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL)), aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[L_ORDERKEY], groupingSets=Noop, byRow=true, maxNumEntries=2416}]}",
              "TimeseriesQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[O_ORDERKEY], groupingSets=Noop, byRow=true, maxNumEntries=3655}]}",
              "TimeseriesQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[O_ORDERKEY], groupingSets=Noop, byRow=true, maxNumEntries=3655}]}",
              "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+nation, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NAME:string, S_NATIONKEY:string, S_SUPPKEY:string, N_NAME:string, N_NATIONKEY:string}, applyFilter=true}}",
              "StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL) && BloomFilter{fields=[DefaultDimensionSpec{dimension='O_ORDERKEY', outputName='O_ORDERKEY'}], groupingSets=Noop}), columns=[O_ORDERKEY, O_ORDERSTATUS], $hash=true}",
              "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1], $hash=true}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}",
              "StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}",
              "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}",
              "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}",
              "StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}",
              "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}",
          ...
          hook.verifyHooked(
              "FAMKJmLmPKbL/eyJiKisTw==",
              "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY]}",
              "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NAME, N_NATIONKEY]}",
              "StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_NATIONKEY], rightAlias=nation, rightJoinColumns=[N_NATIONKEY]}, hashLeft=false, hashSignature={N_NAME:string, N_NATIONKEY:string}, applyFilter=true}}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+nation, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NAME:string, S_NATIONKEY:string, S_SUPPKEY:string, N_NAME:string, N_NATIONKEY:string}, applyFilter=true}, $hash=true}, StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERSTATUS]}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1], $hash=true}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='S_NAME', outputName='d0'}], filter=p0==NULL, aggregatorSpecs=[CountAggregatorFactory{name='a0'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='a0', direction=descending}, OrderByColumnSpec{dimension='d0', direction=ascending}], limit=100}, outputColumns=[d0, a0]}",
              "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier+nation, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NAME:string, S_NATIONKEY:string, S_SUPPKEY:string, N_NAME:string, N_NATIONKEY:string}, applyFilter=true}, $hash=true}",
              "StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERSTATUS]}",
              "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1], $hash=true}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}",
              "StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}",
              "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}",
              "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY], localPostProcessing=BroadcastJoinProcessor{element=JoinElement{joinType=INNER, leftAlias=supplier, leftJoinColumns=[S_SUPPKEY], rightAlias=lineitem, rightJoinColumns=[L_SUPPKEY]}, hashLeft=true, hashSignature={S_NATIONKEY:string, S_SUPPKEY:string}}}",
              "StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}",
              "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}",
        ...
        if (bloomFilter) {
          hook.verifyHooked(
              "TnW3iIa86qnWkiDH/TRv1w==",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY]}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERSTATUS]}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=BloomDimFilter.Factory{bloomSource=$view:nation[N_NATIONKEY](N_NAME=='UNITED STATES'), fields=[DefaultDimensionSpec{dimension='S_NATIONKEY', outputName='S_NATIONKEY'}], groupingSets=Noop, maxNumEntries=1}, columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomDimFilter.Factory{bloomSource=$view:orders[O_ORDERKEY](O_ORDERSTATUS=='F'), fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop, maxNumEntries=3655}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1], $hash=true}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=BloomDimFilter.Factory{bloomSource=$view:nation[N_NATIONKEY](N_NAME=='UNITED STATES'), fields=[DefaultDimensionSpec{dimension='S_NATIONKEY', outputName='S_NATIONKEY'}], groupingSets=Noop, maxNumEntries=1}, columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomDimFilter.Factory{bloomSource=$view:orders[O_ORDERKEY](O_ORDERSTATUS=='F'), fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop, maxNumEntries=3655}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='S_NAME', outputName='d0'}], filter=p0==NULL, aggregatorSpecs=[CountAggregatorFactory{name='a0'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='a0', direction=descending}, OrderByColumnSpec{dimension='d0', direction=ascending}], limit=100}, outputColumns=[d0, a0]}",
              "TimeseriesQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[N_NATIONKEY], groupingSets=Noop, byRow=true, maxNumEntries=1}]}",
              "TimeseriesQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[O_ORDERKEY], groupingSets=Noop, byRow=true, maxNumEntries=3655}]}",
              "TimeseriesQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[N_NATIONKEY], groupingSets=Noop, byRow=true, maxNumEntries=1}]}",
              "TimeseriesQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[O_ORDERKEY], groupingSets=Noop, byRow=true, maxNumEntries=3655}]}",
              "StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY]}",
              "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NAME, N_NATIONKEY], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY]}",
              "StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERSTATUS]}",
              "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=BloomFilter{fields=[DefaultDimensionSpec{dimension='S_NATIONKEY', outputName='S_NATIONKEY'}], groupingSets=Noop}, columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1], $hash=true}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=BloomFilter{fields=[DefaultDimensionSpec{dimension='S_NATIONKEY', outputName='S_NATIONKEY'}], groupingSets=Noop}, columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
              "StreamQuery{dataSource='supplier', filter=BloomFilter{fields=[DefaultDimensionSpec{dimension='S_NATIONKEY', outputName='S_NATIONKEY'}], groupingSets=Noop}, columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY]}",
              "StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}",
              "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}",
              "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=BloomFilter{fields=[DefaultDimensionSpec{dimension='S_NATIONKEY', outputName='S_NATIONKEY'}], groupingSets=Noop}, columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=BloomFilter{fields=[DefaultDimensionSpec{dimension='S_NATIONKEY', outputName='S_NATIONKEY'}], groupingSets=Noop}, columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
              "StreamQuery{dataSource='supplier', filter=BloomFilter{fields=[DefaultDimensionSpec{dimension='S_NATIONKEY', outputName='S_NATIONKEY'}], groupingSets=Noop}, columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && BloomFilter{fields=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='L_ORDERKEY'}], groupingSets=Noop}), columns=[L_ORDERKEY, L_SUPPKEY]}",
              "StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}",
          ...
          hook.verifyHooked(
              "7FcqUOkrJjXQAs1Zo2Pp8g==",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY]}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERSTATUS]}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1], $hash=true}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='S_NAME', outputName='d0'}], filter=p0==NULL, aggregatorSpecs=[CountAggregatorFactory{name='a0'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='a0', direction=descending}, OrderByColumnSpec{dimension='d0', direction=ascending}], limit=100}, outputColumns=[d0, a0]}",
              "StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY]}",
              "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NAME, N_NATIONKEY], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY]}",
              "StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERSTATUS]}",
              "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1], $hash=true}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
              "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY]}",
              "StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}",
              "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}",
              "GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}",
              "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}, StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}",
              "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}",
              "StreamQuery{dataSource='lineitem', filter=MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'}, columns=[L_ORDERKEY, L_SUPPKEY]}",
              "StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY], $hash=true}",
