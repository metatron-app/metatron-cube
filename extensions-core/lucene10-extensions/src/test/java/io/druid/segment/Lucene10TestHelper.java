...
import io.druid.segment.lucene.Lucene10ExtensionModule;
...
public class Lucene10TestHelper extends TestHelper
{
  ...
  static {
    ...
    for (Module module : new Lucene10ExtensionModule().getJacksonModules()) {
      mapper.registerModule(module);
    }
