...
public class IndexSpecTest
{
  ...
  {
    final ObjectMapper mapper = Lucene10TestHelper.segmentWalker.getMapper();
    final IndexSpec spec = new IndexSpec(
        null, null, null, null,
        ImmutableMap.<String, SecondaryIndexingSpec>of(
            "gis", Lucene10IndexingSpec.of(
                "standard",
    ...
    Assert.assertEquals(
        "{\"bitmap\":{\"type\":\"roaring\"},\"secondaryIndexing\":{\"gis\":{\"type\":\"lucene10\",\"textAnalyzer\":\"standard\",\"strategies\":[{\"type\":\"latlon\",\"fieldName\":\"coord\",\"latitude\":\"lat\",\"longitude\":\"lon\",\"crs\":null},{\"type\":\"text\",\"fieldName\":\"text\"}]}},\"allowNullForNumbers\":false}",
