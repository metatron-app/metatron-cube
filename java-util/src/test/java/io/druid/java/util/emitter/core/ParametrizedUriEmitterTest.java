...
import static io.druid.java.util.emitter.core.EmitterTest.okResponse;
...
public class ParametrizedUriEmitterTest
{
  ...
  private Emitter parametrizedEmmiter(String uriPattern) throws Exception
  {
    ...
    props.setProperty("io.druid.java.util.emitter.type", "parametrized");
    props.setProperty("io.druid.java.util.emitter.recipientBaseUrlPattern", uriPattern);
