...
public class TpchTest extends TpchTestHelper
{
  ...
  public void tpch20() throws Exception
  {
    testQuery(
        ...
        + "        DruidOuterQueryRel(scanFilter=[IS NOT NULL($0)], group=[{0, 1}], agg#0=[SUM($2)], aggregateProject=[$0, *(0.5:DECIMAL(2, 1), $2), $1])\n"
