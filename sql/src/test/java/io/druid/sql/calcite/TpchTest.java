...
public class TpchTest extends TpchTestHelper
{
  ...
  public static final String TPCH16_EXPLAIN_JR =
      "DruidOuterQueryRel(scanFilter=[OR(=($4, 0), AND(IS NULL($5), >=($6, $4), IS NOT NULL($3)))], scanProject=[$0, $1, $2, $3], group=[{0, 1, 2}], supplier_cnt=[COUNT(DISTINCT $3)], sort=[$3:DESC, $0:ASC, $1:ASC, $2:ASC])\n"
      + "  DruidJoinRel(joinType=[INNER], outputColumns=[2, 5, 4, 1, 8, 7, 9])\n"
  ...
  public static final String TPCH21_2_EXPLAIN =
      ...
      + "  DruidJoinRel(joinType=[LEFT], leftKeys=[4, 6], rightKeys=[0, 1], outputColumns=[0, 15])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[4, 6], rightKeys=[0, 1])\n"
      + "      DruidOuterQueryRel(scanProject=[$0, $1, $2, $3, $4, $5, $6, $9, $10, $7, $8])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[4], rightKeys=[0])\n"
      + "          DruidOuterQueryRel(scanProject=[$0, $1, $2, $5, $6, $7, $8, $3, $4])\n"
      + "            DruidJoinRel(joinType=[INNER], leftKeys=[2], rightKeys=[3])\n"
  ...
  public static final String TPCH21_2_EXPLAIN_JR =
      "DruidOuterQueryRel(scanFilter=[IS NULL($1)], scanProject=[$0], group=[{0}], NUMWAIT=[COUNT()], sort=[$1:DESC, $0:ASC], fetch=[100])\n"
      + "  DruidJoinRel(joinType=[LEFT], leftKeys=[1, 3], rightKeys=[0, 1], outputColumns=[8, 15])\n"
      + "    DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[2])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[1], rightKeys=[0])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[1, 3], rightKeys=[0, 1])\n"
      + "          DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(>($9, $1), IS NOT NULL($14), IS NOT NULL($6))], scanProject=[$1, $6, $9, $14])\n"
      + "          DruidOuterQueryRel(scanFilter=[<>($2, $1)], scanProject=[$0, $1], group=[{0, 1}])\n"
      + "            DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[0], outputColumns=[2, 3, 1])\n"
      + "              DruidQueryRel(table=[druid.lineitem], scanFilter=[IS NOT NULL($6)], scanProject=[$6, $14])\n"
  ...
  public static final String TPCH21_2_EXPLAIN_JR2 =
      "DruidOuterQueryRel(scanFilter=[IS NULL($1)], scanProject=[$0], group=[{0}], NUMWAIT=[COUNT()], sort=[$1:DESC, $0:ASC], fetch=[100])\n"
      + "  DruidJoinRel(joinType=[INNER], leftKeys=[0], rightKeys=[1], outputColumns=[8, 15])\n"
      + "    DruidQueryRel(table=[druid.orders], scanFilter=[AND(=($6, 'F'), IS NOT NULL($4))], scanProject=[$4, $6])\n"
      + "    DruidJoinRel(joinType=[LEFT], leftKeys=[1, 3], rightKeys=[0, 1])\n"
      + "      DruidJoinRel(joinType=[INNER], leftKeys=[3], rightKeys=[2])\n"
      + "        DruidJoinRel(joinType=[INNER], leftKeys=[1, 3], rightKeys=[0, 1])\n"
      + "          DruidQueryRel(table=[druid.lineitem], scanFilter=[AND(>($9, $1), IS NOT NULL($14), IS NOT NULL($6))], scanProject=[$1, $6, $9, $14])\n"
      + "          DruidOuterQueryRel(scanFilter=[<>($2, $1)], scanProject=[$0, $1], group=[{0, 1}])\n"
  ...
  public void tpch21_2() throws Exception
  {
    ...
    if (semiJoin) {
      if (broadcastJoin) {
        ...
        hook.verifyHooked(
            "K2i+bd+Q5r/w1gDq4cfPLw==",
            "StreamQuery{dataSource='supplier', columns=[S_NATIONKEY, S_SUPPKEY], $hash=true}",
            "StreamQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', columns=[O_ORDERKEY]}",
            "StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NAME, N_NATIONKEY], $hash=true}",
            "GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=(!(S_SUPPKEY==NULL) && S_NATIONKEY=='24'), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY]}, MaterializedQuery{dataSource=[nation]}], timeColumnName=__time}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY]}], timeColumnName=__time}', columns=[S_NAME, S_NATIONKEY, S_SUPPKEY, L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY, N_NAME, N_NATIONKEY], $hash=true}, StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERSTATUS]}], timeColumnName=__time}', columns=[S_NAME, S_NATIONKEY, S_SUPPKEY, L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY, O_ORDERKEY, O_ORDERSTATUS, N_NAME, N_NATIONKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=!(L_ORDERKEY==NULL), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[MaterializedQuery{dataSource=[supplier]}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, outputColumns=[_d0, _d1], $hash=true}], timeColumnName=__time}, GroupByQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_ORDERKEY==NULL)), columns=[L_ORDERKEY, L_SUPPKEY]}, GroupByQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[MaterializedQuery{dataSource=[supplier]}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && InDimFilter{dimension='L_SUPPKEY', values=[1, 10, 11, 12, 13, 14, 15, 16, 17, 18, ..40 more]} && InDimFilter{dimension='L_ORDERKEY', values=[10016, 10018, 10019, 10021, 10022, 10048, 10052, 10053, 10080, 10081, ..3645 more]}), columns=[L_ORDERKEY, L_SUPPKEY]}], timeColumnName=__time}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NATIONKEY], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='L_ORDERKEY', outputName='d0'}, DefaultDimensionSpec{dimension='L_SUPPKEY', outputName='d1'}], outputColumns=[d0, d1], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='d0', outputName='_d0'}, DefaultDimensionSpec{dimension='d1', outputName='_d1'}], filter=MathExprFilter{expression='(L_SUPPKEY != d1)'}, postAggregatorSpecs=[MathPostAggregator{name='p0', expression='true', finalize=true}], outputColumns=[_d0, _d1, p0], $hash=true}], timeColumnName=__time}', dimensions=[DefaultDimensionSpec{dimension='S_NAME', outputName='d0'}], filter=p0==NULL, aggregatorSpecs=[CountAggregatorFactory{name='a0'}], limitSpec=LimitSpec{columns=[OrderByColumnSpec{dimension='a0', direction=descending}, OrderByColumnSpec{dimension='d0', direction=ascending}], limit=100}, outputColumns=[d0, a0]}",
            "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=(!(S_SUPPKEY==NULL) && S_NATIONKEY=='24'), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY]}, MaterializedQuery{dataSource=[nation]}], timeColumnName=__time}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY]}], timeColumnName=__time}', columns=[S_NAME, S_NATIONKEY, S_SUPPKEY, L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY, N_NAME, N_NATIONKEY], $hash=true}, StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERSTATUS]}], timeColumnName=__time}', columns=[S_NAME, S_NATIONKEY, S_SUPPKEY, L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY, O_ORDERKEY, O_ORDERSTATUS, N_NAME, N_NATIONKEY]}",
            "StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=(!(S_SUPPKEY==NULL) && S_NATIONKEY=='24'), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY]}, MaterializedQuery{dataSource=[nation]}], timeColumnName=__time}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY]}], timeColumnName=__time}', columns=[S_NAME, S_NATIONKEY, S_SUPPKEY, L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY, N_NAME, N_NATIONKEY], $hash=true}",
      ...
      if (broadcastJoin) {
        ...
        if (bloomFilter) {
          hook.verifyHooked(
              ...
              "TimeseriesQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[N_NATIONKEY], groupingSets=Noop, byRow=true, maxNumEntries=1}]}",
              "TimeseriesQuery{dataSource='orders', filter=O_ORDERSTATUS=='F', aggregatorSpecs=[BloomFilterAggregatorFactory{name='$bloom', fieldNames=[O_ORDERKEY], groupingSets=Noop, byRow=true, maxNumEntries=3655}]}",
              "StreamQuery{dataSource='CommonJoin{queries=[StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY]}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY]}], timeColumnName=__time}', columns=[S_NAME, S_NATIONKEY, S_SUPPKEY, L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY, N_NAME, N_NATIONKEY], $hash=true}, StreamQuery{dataSource='orders', filter=(O_ORDERSTATUS=='F' && !(O_ORDERKEY==NULL)), columns=[O_ORDERKEY, O_ORDERSTATUS]}], timeColumnName=__time}', columns=[S_NAME, S_NATIONKEY, S_SUPPKEY, L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY, O_ORDERKEY, O_ORDERSTATUS, N_NAME, N_NATIONKEY]}",
              "StreamQuery{dataSource='CommonJoin{queries=[CommonJoin{queries=[StreamQuery{dataSource='supplier', filter=!(S_SUPPKEY==NULL), columns=[S_NAME, S_NATIONKEY, S_SUPPKEY]}, StreamQuery{dataSource='nation', filter=N_NAME=='UNITED STATES', columns=[N_NAME, N_NATIONKEY], $hash=true}], timeColumnName=__time}, StreamQuery{dataSource='lineitem', filter=(MathExprFilter{expression='(L_RECEIPTDATE > L_COMMITDATE)'} && !(L_SUPPKEY==NULL) && !(L_ORDERKEY==NULL)), columns=[L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY]}], timeColumnName=__time}', columns=[S_NAME, S_NATIONKEY, S_SUPPKEY, L_COMMITDATE, L_ORDERKEY, L_RECEIPTDATE, L_SUPPKEY, N_NAME, N_NATIONKEY], $hash=true}",
